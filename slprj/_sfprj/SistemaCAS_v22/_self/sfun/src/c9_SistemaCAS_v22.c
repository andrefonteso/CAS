...
static const char * c9_debug_family_names[10] = { "nargin", "nargout", "k",
  "alfa", "caminhos", "perda_transmissao1", "perda_transmissao2",
  "perda_transmissao3", "perda_transmissao4", "perda_transmissao5" };

/* Function Declarations */
static void initialize_c9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
static void initialize_params_c9_SistemaCAS_v22
  (SFc9_SistemaCAS_v22InstanceStruct *chartInstance);
static void enable_c9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
static void disable_c9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
static void c9_update_debugger_state_c9_SistemaCAS_v22
  (SFc9_SistemaCAS_v22InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_SistemaCAS_v22
  (SFc9_SistemaCAS_v22InstanceStruct *chartInstance);
static void set_sim_state_c9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance, const mxArray *c9_st);
static void finalize_c9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
static void sf_gateway_c9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
static void c9_chartstep_c9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
static void initSimStructsc9_SistemaCAS_v22(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance, const mxArray *c9_perda_transmissao5, const char_T
  *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_SistemaCAS_v22InstanceStruct
...
static real_T c9_log10(SFc9_SistemaCAS_v22InstanceStruct *chartInstance, real_T
  c9_x);
static void c9_eml_error(SFc9_SistemaCAS_v22InstanceStruct *chartInstance);
static real_T c9_mpower(SFc9_SistemaCAS_v22InstanceStruct *chartInstance, real_T
  c9_a, real_T c9_b);
static void c9_eml_scalar_eg(SFc9_SistemaCAS_v22InstanceStruct *chartInstance);
static void c9_b_eml_error(SFc9_SistemaCAS_v22InstanceStruct *chartInstance);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_d_emlrt_marshallIn(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_SistemaCAS_v22, const char_T *
  c9_identifier);
static uint8_T c9_e_emlrt_marshallIn(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_log10(SFc9_SistemaCAS_v22InstanceStruct *chartInstance, real_T *
  c9_x);
static void init_dsm_address_info(SFc9_SistemaCAS_v22InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_SistemaCAS_v22 = 0U;
}
  ...
  (SFc9_SistemaCAS_v22InstanceStruct *chartInstance)
{
  ...
  c9_f_hoistedGlobal = chartInstance->c9_is_active_c9_SistemaCAS_v22;
  ...
  *chartInstance, const mxArray *c9_st)
{
  ...
  *c9_perda_transmissao5 = c9_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c9_is_active_c9_SistemaCAS_v22 = c9_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 5)),
     "is_active_c9_SistemaCAS_v22");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_SistemaCAS_v22(chartInstance);
  ...
  *chartInstance)
{
  ...
  c9_perda_transmissao3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c9_perda_transmissao2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c9_caminhos = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 2);
  c9_perda_transmissao1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c9_alfa = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
  c9_k = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 6U, chartInstance->c9_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c9_k, 0U);
  for (c9_i0 = 0; c9_i0 < 5; c9_i0++) {
    _SFD_DATA_RANGE_CHECK((*c9_alfa)[c9_i0], 1U);
  }

  chartInstance->c9_sfEvent = CALL_EVENT;
  c9_chartstep_c9_SistemaCAS_v22(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v22MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c9_perda_transmissao1, 2U);
  for (c9_i1 = 0; c9_i1 < 5; c9_i1++) {
    _SFD_DATA_RANGE_CHECK((*c9_caminhos)[c9_i1], 3U);
  }

  _SFD_DATA_RANGE_CHECK(*c9_perda_transmissao2, 4U);
  _SFD_DATA_RANGE_CHECK(*c9_perda_transmissao3, 5U);
  _SFD_DATA_RANGE_CHECK(*c9_perda_transmissao4, 6U);
  _SFD_DATA_RANGE_CHECK(*c9_perda_transmissao5, 7U);
}
  ...
  *chartInstance)
{
  ...
  c9_b_caminhos = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 2);
  c9_b_perda_transmissao1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c9_b_alfa = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
  c9_b_k = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 6U, chartInstance->c9_sfEvent);
  c9_hoistedGlobal = *c9_b_k;
  c9_k = c9_hoistedGlobal;
  for (c9_i2 = 0; c9_i2 < 5; c9_i2++) {
    c9_alfa[c9_i2] = (*c9_b_alfa)[c9_i2];
  }

  for (c9_i3 = 0; c9_i3 < 5; c9_i3++) {
    c9_caminhos[c9_i3] = (*c9_b_caminhos)[c9_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_nargout, 1U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c9_k, 2U, c9_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c9_alfa, 3U, c9_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c9_caminhos, 4U, c9_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao1, 5U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao2, 6U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao3, 7U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao4, 8U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao5, 9U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 14);
  c9_d0 = c9_caminhos[0];
  c9_b_log10(chartInstance, &c9_d0);
  c9_A = c9_k * 10.0 * c9_d0;
  c9_x = c9_A;
  c9_b_x = c9_x;
  c9_c_x = c9_b_x;
  c9_y = c9_c_x / 10.0;
  ...
  c9_b_A = 10.0 * c9_d1 * c9_caminhos[0] * 0.001;
  c9_d_x = c9_b_A;
  c9_e_x = c9_d_x;
  c9_f_x = c9_e_x;
  c9_b_y = c9_f_x / 10.0;
  c9_d2 = c9_mpower(chartInstance, 10.0, c9_y) + c9_mpower(chartInstance, 10.0,
    c9_b_y);
  c9_b_log10(chartInstance, &c9_d2);
  c9_perda_transmissao1 = 10.0 * c9_d2;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 15);
  c9_d3 = c9_caminhos[1];
  c9_b_log10(chartInstance, &c9_d3);
  c9_c_A = c9_k * 10.0 * c9_d3;
  c9_g_x = c9_c_A;
  c9_h_x = c9_g_x;
  c9_i_x = c9_h_x;
  c9_c_y = c9_i_x / 10.0;
  ...
  c9_d_A = 10.0 * c9_d4 * c9_caminhos[1] * 0.001;
  c9_j_x = c9_d_A;
  c9_k_x = c9_j_x;
  c9_l_x = c9_k_x;
  c9_d_y = c9_l_x / 10.0;
  c9_d5 = c9_mpower(chartInstance, 10.0, c9_c_y) + c9_mpower(chartInstance, 10.0,
    c9_d_y);
  c9_b_log10(chartInstance, &c9_d5);
  c9_perda_transmissao2 = 10.0 * c9_d5;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 16);
  c9_d6 = c9_caminhos[2];
  c9_b_log10(chartInstance, &c9_d6);
  c9_e_A = c9_k * 10.0 * c9_d6;
  c9_m_x = c9_e_A;
  c9_n_x = c9_m_x;
  c9_o_x = c9_n_x;
  c9_e_y = c9_o_x / 10.0;
  c9_d7 = c9_alfa[2];
  c9_b_log10(chartInstance, &c9_d7);
  c9_f_A = 10.0 * c9_d7 * c9_caminhos[2] * 0.001;
  c9_p_x = c9_f_A;
  c9_q_x = c9_p_x;
  c9_r_x = c9_q_x;
  c9_f_y = c9_r_x / 10.0;
  c9_d8 = c9_mpower(chartInstance, 10.0, c9_e_y) + c9_mpower(chartInstance, 10.0,
    c9_f_y);
  c9_b_log10(chartInstance, &c9_d8);
  c9_perda_transmissao3 = 10.0 * c9_d8;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 17);
  c9_d9 = c9_caminhos[3];
  c9_b_log10(chartInstance, &c9_d9);
  c9_g_A = c9_k * 10.0 * c9_d9;
  c9_s_x = c9_g_A;
  c9_t_x = c9_s_x;
  c9_u_x = c9_t_x;
  c9_g_y = c9_u_x / 10.0;
  c9_d10 = c9_alfa[3];
  c9_b_log10(chartInstance, &c9_d10);
  c9_h_A = 10.0 * c9_d10 * c9_caminhos[3] * 0.001;
  c9_v_x = c9_h_A;
  c9_w_x = c9_v_x;
  c9_x_x = c9_w_x;
  c9_h_y = c9_x_x / 10.0;
  c9_d11 = c9_mpower(chartInstance, 10.0, c9_g_y) + c9_mpower(chartInstance,
    10.0, c9_h_y);
  c9_b_log10(chartInstance, &c9_d11);
  c9_perda_transmissao4 = 10.0 * c9_d11;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 18);
  c9_d12 = c9_caminhos[4];
  c9_b_log10(chartInstance, &c9_d12);
  c9_i_A = c9_k * 10.0 * c9_d12;
  c9_y_x = c9_i_A;
  c9_ab_x = c9_y_x;
  c9_bb_x = c9_ab_x;
  c9_i_y = c9_bb_x / 10.0;
  c9_d13 = c9_alfa[4];
  c9_b_log10(chartInstance, &c9_d13);
  c9_j_A = 10.0 * c9_d13 * c9_caminhos[4] * 0.001;
  c9_cb_x = c9_j_A;
  c9_db_x = c9_cb_x;
  c9_eb_x = c9_db_x;
  c9_j_y = c9_eb_x / 10.0;
  c9_d14 = c9_mpower(chartInstance, 10.0, c9_i_y) + c9_mpower(chartInstance,
    10.0, c9_j_y);
  c9_b_log10(chartInstance, &c9_d14);
  c9_perda_transmissao5 = 10.0 * c9_d14;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, -18);
  _SFD_SYMBOL_SCOPE_POP();
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_SistemaCAS_v22InstanceStruct *chartInstance;
  chartInstance = (SFc9_SistemaCAS_v22InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId)
{
  ...
  real_T c9_d15;
  (void)chartInstance;
  sf_mex_import(c9_parentId, sf_mex_dup(c9_u), &c9_d15, 1, 0, 0U, 0, 0U, 0);
  c9_y = c9_d15;
  sf_mex_destroy(&c9_u);
  return c9_y;
}
  ...
  *c9_inData)
{
  ...
  for (c9_i4 = 0; c9_i4 < 5; c9_i4++) {
    c9_b_inData[c9_i4] = (*(real_T (*)[5])c9_inData)[c9_i4];
  }
...
const mxArray *sf_c9_SistemaCAS_v22_get_eml_resolved_functions_info(void)
{
  const mxArray *c9_nameCaptureInfo = NULL;
  c9_nameCaptureInfo = NULL;
  sf_mex_assign(&c9_nameCaptureInfo, sf_mex_createstruct("structure", 2, 28, 1),
                false);
...
static void c9_info_helper(const mxArray **c9_info)
{
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("mpower"), "name", "name", 14);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 16);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("ismatrix"), "name", "name", 16);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 17);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("power"), "name", "name", 17);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
  ...
  c9_a, real_T c9_b)
{
  ...
  c9_ar = c9_d_a;
  c9_br = c9_d_b;
  return muDoubleScalarPower(c9_ar, c9_br);
}
...
{
  int32_T c9_i8;
  static char_T c9_cv2[31] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o', 'l',
  ...
  const mxArray *c9_y = NULL;
  (void)chartInstance;
  for (c9_i8 = 0; c9_i8 < 31; c9_i8++) {
    c9_u[c9_i8] = c9_cv2[c9_i8];
  }
  ...
  c9_identifier)
{
  ...
  c9_y = c9_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_SistemaCAS_v22), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_SistemaCAS_v22);
  return c9_y;
}
...
void sf_c9_SistemaCAS_v22_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2744698186U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2545465493U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2841875811U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(447802174U);
}

mxArray *sf_c9_SistemaCAS_v22_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dvGBXPnF3Ijh2M7tdgAn9F");
...
mxArray *sf_c9_SistemaCAS_v22_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_SistemaCAS_v22_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c9_SistemaCAS_v22(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"perda_transmissao1\",},{M[1],M[9],T\"perda_transmissao2\",},{M[1],M[10],T\"perda_transmissao3\",},{M[1],M[11],T\"perda_transmissao4\",},{M[1],M[12],T\"perda_transmissao5\",},{M[8],M[0],T\"is_active_c9_SistemaCAS_v22\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_SistemaCAS_v22_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_SistemaCAS_v22InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,"perda_transmissao1");
          _SFD_SET_DATA_PROPS(3,1,1,0,"caminhos");
          _SFD_SET_DATA_PROPS(4,2,0,1,"perda_transmissao2");
          _SFD_SET_DATA_PROPS(5,2,0,1,"perda_transmissao3");
          _SFD_SET_DATA_PROPS(6,2,0,1,"perda_transmissao4");
          _SFD_SET_DATA_PROPS(7,2,0,1,"perda_transmissao5");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1137);
...

        {
          ...
          c9_alfa = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
          c9_k = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c9_k);
          _SFD_SET_DATA_VALUE_PTR(1U, *c9_alfa);
          _SFD_SET_DATA_VALUE_PTR(2U, c9_perda_transmissao1);
          _SFD_SET_DATA_VALUE_PTR(3U, *c9_caminhos);
          _SFD_SET_DATA_VALUE_PTR(4U, c9_perda_transmissao2);
          _SFD_SET_DATA_VALUE_PTR(5U, c9_perda_transmissao3);
          _SFD_SET_DATA_VALUE_PTR(6U, c9_perda_transmissao4);
          _SFD_SET_DATA_VALUE_PTR(7U, c9_perda_transmissao5);
        }
      }
    } else {
...
{
  return "QCdQppUTuHek72xFSTNYJE";
}

static void sf_opaque_initialize_c9_SistemaCAS_v22(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_SistemaCAS_v22InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*)
    chartInstanceVar);
  initialize_c9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_SistemaCAS_v22(void *chartInstanceVar)
{
  enable_c9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_SistemaCAS_v22(void *chartInstanceVar)
{
  disable_c9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_SistemaCAS_v22(void *chartInstanceVar)
{
  sf_gateway_c9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_SistemaCAS_v22(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_SistemaCAS_v22
    ((SFc9_SistemaCAS_v22InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v22();/* state var info */
...
extern void sf_internal_set_sim_state_c9_SistemaCAS_v22(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v22();/* state var info */
  ...
  set_sim_state_c9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_SistemaCAS_v22(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_SistemaCAS_v22(S);
}

static void sf_opaque_set_sim_state_c9_SistemaCAS_v22(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_SistemaCAS_v22(S, st);
}

static void sf_opaque_terminate_c9_SistemaCAS_v22(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_SistemaCAS_v22InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_SistemaCAS_v22((SFc9_SistemaCAS_v22InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_SistemaCAS_v22(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_SistemaCAS_v22(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3359740942U));
  ssSetChecksum1(S,(2580217979U));
  ssSetChecksum2(S,(3009496349U));
  ssSetChecksum3(S,(1730973913U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c9_SistemaCAS_v22(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_SistemaCAS_v22(SimStruct *S)
{
  SFc9_SistemaCAS_v22InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_SistemaCAS_v22InstanceStruct *)utMalloc(sizeof
    (SFc9_SistemaCAS_v22InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_SistemaCAS_v22InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_SistemaCAS_v22;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_SistemaCAS_v22;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_SistemaCAS_v22;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_SistemaCAS_v22;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_SistemaCAS_v22;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_SistemaCAS_v22;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_SistemaCAS_v22;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_SistemaCAS_v22;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_SistemaCAS_v22;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_SistemaCAS_v22;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_SistemaCAS_v22;
...
void c9_SistemaCAS_v22_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_SistemaCAS_v22(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_SistemaCAS_v22(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_SistemaCAS_v22(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_SistemaCAS_v22_method_dispatcher.\n"
