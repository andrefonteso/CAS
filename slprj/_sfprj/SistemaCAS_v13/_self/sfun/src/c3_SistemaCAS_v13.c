...
#include <stddef.h>
#include "blas.h"
#include "SistemaCAS_v13_sfun.h"
#include "c3_SistemaCAS_v13.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "SistemaCAS_v13_sfun_debug_macros.h"
...
static const char * c3_debug_family_names[18] = { "T", "S", "pH", "D", "f1",
  "f2", "a", "atenuacao3", "atenuacaomag", "sinal_atenuado3", "nargin",
  "nargout", "parametros_aquario", "parametros_ambientais", "frequencia",
  "sinal_espalhado3", "caminhos", "sinal_atenuado_total" };

/* Function Declarations */
static void initialize_c3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
static void initialize_params_c3_SistemaCAS_v13
  (SFc3_SistemaCAS_v13InstanceStruct *chartInstance);
static void enable_c3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
static void disable_c3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_SistemaCAS_v13
  (SFc3_SistemaCAS_v13InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_SistemaCAS_v13
  (SFc3_SistemaCAS_v13InstanceStruct *chartInstance);
static void set_sim_state_c3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
static void sf_gateway_c3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
static void initSimStructsc3_SistemaCAS_v13(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance, const mxArray *c3_sinal_atenuado_total, const char_T
  *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_SistemaCAS_v13InstanceStruct
...
static void c3_eml_error(SFc3_SistemaCAS_v13InstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_SistemaCAS_v13InstanceStruct *chartInstance, real_T
  c3_a);
static void c3_eml_scalar_eg(SFc3_SistemaCAS_v13InstanceStruct *chartInstance);
static void c3_b_eml_error(SFc3_SistemaCAS_v13InstanceStruct *chartInstance);
static real_T c3_db2mag(SFc3_SistemaCAS_v13InstanceStruct *chartInstance, real_T
  c3_ydb);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_SistemaCAS_v13, const char_T *
  c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_SistemaCAS_v13InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_SistemaCAS_v13 = 0U;
}
  ...
  (SFc3_SistemaCAS_v13InstanceStruct *chartInstance)
{
  ...
  real_T *c3_sinal_atenuado_total;
  c3_sinal_atenuado_total = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellmatrix(2, 1), false);
  c3_hoistedGlobal = *c3_sinal_atenuado_total;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_SistemaCAS_v13;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_sinal_atenuado_total = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 0)), "sinal_atenuado_total");
  chartInstance->c3_is_active_c3_SistemaCAS_v13 = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_SistemaCAS_v13");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_SistemaCAS_v13(chartInstance);
  ...
  *chartInstance)
{
  ...
  c3_sinal_atenuado_total = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_caminhos = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c3_sinal_espalhado3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  for (c3_i0 = 0; c3_i0 < 3; c3_i0++) {
    _SFD_DATA_RANGE_CHECK((*c3_parametros_aquario)[c3_i0], 0U);
  }

  for (c3_i1 = 0; c3_i1 < 3; c3_i1++) {
    _SFD_DATA_RANGE_CHECK((*c3_parametros_ambientais)[c3_i1], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c3_frequencia, 2U);
  _SFD_DATA_RANGE_CHECK(*c3_sinal_espalhado3, 3U);
  _SFD_DATA_RANGE_CHECK(*c3_caminhos, 4U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_SistemaCAS_v13(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v13MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c3_sinal_atenuado_total, 5U);
}
  ...
  *chartInstance)
{
  ...
  real_T c3_f2;
  real_T c3_a;
  real_T c3_atenuacao3;
  real_T c3_atenuacaomag;
  real_T c3_sinal_atenuado3;
  ...
  real_T *c3_b_caminhos;
  real_T *c3_b_sinal_espalhado3;
  real_T *c3_b_frequencia;
  real_T *c3_b_sinal_atenuado_total;
  real_T (*c3_b_parametros_ambientais)[3];
  real_T (*c3_b_parametros_aquario)[3];
  c3_b_sinal_atenuado_total = (real_T *)ssGetOutputPortSignal(chartInstance->S,
    1);
  c3_b_caminhos = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c3_b_sinal_espalhado3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  c3_b_hoistedGlobal = *c3_b_sinal_espalhado3;
  c3_c_hoistedGlobal = *c3_b_caminhos;
  for (c3_i2 = 0; c3_i2 < 3; c3_i2++) {
    c3_parametros_aquario[c3_i2] = (*c3_b_parametros_aquario)[c3_i2];
  }

  for (c3_i3 = 0; c3_i3 < 3; c3_i3++) {
    c3_parametros_ambientais[c3_i3] = (*c3_b_parametros_ambientais)[c3_i3];
  }

  c3_frequencia = c3_hoistedGlobal;
  c3_sinal_espalhado3 = c3_b_hoistedGlobal;
  c3_caminhos = c3_c_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_a, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacao3, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacaomag, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado3, 9U,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 11U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_parametros_aquario, 12U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_parametros_ambientais, 13U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_frequencia, 14U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado3, 15U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_caminhos, 16U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado_total, 17U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_b_u = c3_f2;
  c3_e_y = NULL;
  sf_mex_assign(&c3_e_y, sf_mex_create("y", &c3_b_u, 0, 0U, 0U, 0U, 0), false);
  ...
  c3_i_A = 0.52 * (1.0 + c3_k_y) * c3_l_y * (c3_f2 * c3_mpower(chartInstance,
  ...
  c3_rb_x = c3_qb_x;
  c3_s_y = c3_rb_x / 17.0;
  c3_sb_x = -(c3_r_y + c3_s_y);
  c3_tb_x = c3_sb_x;
  c3_tb_x = muDoubleScalarExp(c3_tb_x);
  c3_a = (c3_j_y + c3_q_y) + 0.00049 * c3_mpower(chartInstance, c3_frequencia) *
    c3_tb_x;
  sf_mex_printf("%s =\\n", "a");
  c3_c_u = c3_a;
  c3_t_y = NULL;
  sf_mex_assign(&c3_t_y, sf_mex_create("y", &c3_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_t_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 26);
  sf_mex_printf("%s =\\n", "caminhos");
  c3_d_u = c3_caminhos;
  c3_u_y = NULL;
  sf_mex_assign(&c3_u_y, sf_mex_create("y", &c3_d_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_u_y);
  ...
  c3_vb_x = muDoubleScalarLog(c3_vb_x);
  c3_atenuacao3 = 10.0 * c3_vb_x * c3_caminhos;
  sf_mex_printf("%s =\\n", "atenuacao3");
  c3_e_u = c3_atenuacao3;
  c3_v_y = NULL;
  sf_mex_assign(&c3_v_y, sf_mex_create("y", &c3_e_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_v_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 33);
  c3_atenuacaomag = c3_db2mag(chartInstance, c3_atenuacao3);
  sf_mex_printf("%s =\\n", "atenuacaomag");
  c3_f_u = c3_atenuacaomag;
  c3_w_y = NULL;
  sf_mex_assign(&c3_w_y, sf_mex_create("y", &c3_f_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_w_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 34);
  sf_mex_printf("%s =\\n", "sinal_espalhado3");
  c3_g_u = c3_sinal_espalhado3;
  c3_x_y = NULL;
  sf_mex_assign(&c3_x_y, sf_mex_create("y", &c3_g_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_x_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 38);
  c3_sinal_atenuado3 = c3_db2mag(chartInstance, c3_atenuacao3) *
    c3_sinal_espalhado3;
  sf_mex_printf("%s =\\n", "sinal_atenuado3");
  c3_h_u = c3_sinal_atenuado3;
  c3_y_y = NULL;
  sf_mex_assign(&c3_y_y, sf_mex_create("y", &c3_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_y_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 42);
  c3_sinal_atenuado_total = c3_sinal_atenuado3;
  sf_mex_printf("%s =\\n", "sinal_atenuado_total");
  c3_i_u = c3_sinal_atenuado_total;
  c3_ab_y = NULL;
  sf_mex_assign(&c3_ab_y, sf_mex_create("y", &c3_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_ab_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -42);
  _SFD_SYMBOL_SCOPE_POP();
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_SistemaCAS_v13InstanceStruct *chartInstance;
  chartInstance = (SFc3_SistemaCAS_v13InstanceStruct *)chartInstanceVoid;
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_sinal_atenuado_total),
    &c3_thisId);
  sf_mex_destroy(&c3_sinal_atenuado_total);
  return c3_y;
}
...
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_sinal_atenuado_total;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  real_T c3_y;
  SFc3_SistemaCAS_v13InstanceStruct *chartInstance;
  chartInstance = (SFc3_SistemaCAS_v13InstanceStruct *)chartInstanceVoid;
  c3_sinal_atenuado_total = sf_mex_dup(c3_mxArrayInData);
...
const mxArray *sf_c3_SistemaCAS_v13_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("log"), "name", "name", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("db2mag"), "name", "name", 32);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 32);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/controllib/general/db2mag.m"), "resolved",
                  "resolved", 32);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1381346356U), "fileTimeLo",
                  "fileTimeLo", 32);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 32);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs32), "lhs", "lhs",
                  32);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/controllib/general/db2mag.m"), "context",
                  "context", 33);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/controllib/general/db2mag.m"), "context",
                  "context", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("power"), "name", "name", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
...
static void c3_b_eml_error(SFc3_SistemaCAS_v13InstanceStruct *chartInstance)
{
  ...
  const mxArray *c3_y = NULL;
  int32_T c3_i9;
  static char_T c3_cv3[3] = { 'l', 'o', 'g' };

  char_T c3_b_u[3];
  const mxArray *c3_b_y = NULL;
  (void)chartInstance;
  for (c3_i8 = 0; c3_i8 < 30; c3_i8++) {
    c3_u[c3_i8] = c3_cv2[c3_i8];
  }

  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 10, 0U, 1U, 0U, 2, 1, 30), false);
  for (c3_i9 = 0; c3_i9 < 3; c3_i9++) {
    c3_b_u[c3_i9] = c3_cv3[c3_i9];
  }
  ...
  c3_ydb)
{
  ...
  c3_eml_scalar_eg(chartInstance);
  c3_br = c3_c_b;
  return muDoubleScalarPower(10.0, c3_br);
}
  ...
  c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_SistemaCAS_v13), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_SistemaCAS_v13);
  return c3_y;
}
...
void sf_c3_SistemaCAS_v13_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1417217293U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1598728086U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3808630949U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1549307285U);
}

mxArray *sf_c3_SistemaCAS_v13_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kKc6qLkDtrBUEr3Cl4thZC");
...
mxArray *sf_c3_SistemaCAS_v13_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_SistemaCAS_v13_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_SistemaCAS_v13(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[20],T\"sinal_atenuado_total\",},{M[8],M[0],T\"is_active_c3_SistemaCAS_v13\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_SistemaCAS_v13_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SistemaCAS_v13InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_SistemaCAS_v13MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_SistemaCAS_v13MachineNumber_,
          ...
          _SFD_SET_DATA_PROPS(2,1,1,0,"frequencia");
          _SFD_SET_DATA_PROPS(3,1,1,0,"sinal_espalhado3");
          _SFD_SET_DATA_PROPS(4,1,1,0,"caminhos");
          _SFD_SET_DATA_PROPS(5,2,0,1,"sinal_atenuado_total");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1492);
...

        {
          ...
          real_T (*c3_parametros_aquario)[3];
          real_T (*c3_parametros_ambientais)[3];
          c3_sinal_atenuado_total = (real_T *)ssGetOutputPortSignal
            (chartInstance->S, 1);
          c3_caminhos = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
          ...
          c3_parametros_aquario = (real_T (*)[3])ssGetInputPortSignal
            (chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c3_parametros_aquario);
          _SFD_SET_DATA_VALUE_PTR(1U, *c3_parametros_ambientais);
          _SFD_SET_DATA_VALUE_PTR(2U, c3_frequencia);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_sinal_espalhado3);
          _SFD_SET_DATA_VALUE_PTR(4U, c3_caminhos);
          _SFD_SET_DATA_VALUE_PTR(5U, c3_sinal_atenuado_total);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _SistemaCAS_v13MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "OrgTAoAg5dGAhrBKHTGN2G";
}

static void sf_opaque_initialize_c3_SistemaCAS_v13(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_SistemaCAS_v13InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*)
    chartInstanceVar);
  initialize_c3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_SistemaCAS_v13(void *chartInstanceVar)
{
  enable_c3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_SistemaCAS_v13(void *chartInstanceVar)
{
  disable_c3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_SistemaCAS_v13(void *chartInstanceVar)
{
  sf_gateway_c3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_SistemaCAS_v13(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_SistemaCAS_v13
    ((SFc3_SistemaCAS_v13InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v13();/* state var info */
...
extern void sf_internal_set_sim_state_c3_SistemaCAS_v13(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v13();/* state var info */
  ...
  set_sim_state_c3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_SistemaCAS_v13(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_SistemaCAS_v13(S);
}

static void sf_opaque_set_sim_state_c3_SistemaCAS_v13(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_SistemaCAS_v13(S, st);
}

static void sf_opaque_terminate_c3_SistemaCAS_v13(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_SistemaCAS_v13InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SistemaCAS_v13_optimization_info();
    }

    finalize_c3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_SistemaCAS_v13((SFc3_SistemaCAS_v13InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_SistemaCAS_v13(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_SistemaCAS_v13(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_SistemaCAS_v13_optimization_info();
  ...
  ssSetChecksum0(S,(2774171918U));
  ssSetChecksum1(S,(1560461529U));
  ssSetChecksum2(S,(1395461538U));
  ssSetChecksum3(S,(814126837U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_SistemaCAS_v13(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_SistemaCAS_v13(SimStruct *S)
{
  SFc3_SistemaCAS_v13InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_SistemaCAS_v13InstanceStruct *)utMalloc(sizeof
    (SFc3_SistemaCAS_v13InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_SistemaCAS_v13InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_SistemaCAS_v13;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_SistemaCAS_v13;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_SistemaCAS_v13;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_SistemaCAS_v13;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_SistemaCAS_v13;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_SistemaCAS_v13;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_SistemaCAS_v13;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_SistemaCAS_v13;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_SistemaCAS_v13;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_SistemaCAS_v13;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_SistemaCAS_v13;
...
void c3_SistemaCAS_v13_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_SistemaCAS_v13(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_SistemaCAS_v13(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_SistemaCAS_v13(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_SistemaCAS_v13_method_dispatcher.\n"
