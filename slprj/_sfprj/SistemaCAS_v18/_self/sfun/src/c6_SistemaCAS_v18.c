...
static void initialize_c6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
static void initialize_params_c6_SistemaCAS_v18
  (SFc6_SistemaCAS_v18InstanceStruct *chartInstance);
static void enable_c6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
static void disable_c6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_SistemaCAS_v18
  (SFc6_SistemaCAS_v18InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_SistemaCAS_v18
  (SFc6_SistemaCAS_v18InstanceStruct *chartInstance);
static void set_sim_state_c6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
static void sf_gateway_c6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
static void c6_chartstep_c6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
static void initSimStructsc6_SistemaCAS_v18(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance, const mxArray *c6_ruido_total, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_SistemaCAS_v18InstanceStruct
...
static real_T c6_log10(SFc6_SistemaCAS_v18InstanceStruct *chartInstance, real_T
  c6_x);
static void c6_eml_error(SFc6_SistemaCAS_v18InstanceStruct *chartInstance);
static real_T c6_mpower(SFc6_SistemaCAS_v18InstanceStruct *chartInstance, real_T
  c6_a, real_T c6_b);
static void c6_eml_scalar_eg(SFc6_SistemaCAS_v18InstanceStruct *chartInstance);
static void c6_b_eml_error(SFc6_SistemaCAS_v18InstanceStruct *chartInstance);
static void c6_c_eml_error(SFc6_SistemaCAS_v18InstanceStruct *chartInstance);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_SistemaCAS_v18, const char_T *
  c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_log10(SFc6_SistemaCAS_v18InstanceStruct *chartInstance, real_T *
  c6_x);
static void init_dsm_address_info(SFc6_SistemaCAS_v18InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_SistemaCAS_v18 = 0U;
}
  ...
  (SFc6_SistemaCAS_v18InstanceStruct *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_SistemaCAS_v18;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  *c6_ruido_total = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 0)), "ruido_total");
  chartInstance->c6_is_active_c6_SistemaCAS_v18 = c6_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_SistemaCAS_v18");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_SistemaCAS_v18(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_SistemaCAS_v18(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_SistemaCAS_v18InstanceStruct *chartInstance;
  chartInstance = (SFc6_SistemaCAS_v18InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_SistemaCAS_v18_get_eml_resolved_functions_info(void)
{
  ...
  c6_identifier)
{
  ...
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_SistemaCAS_v18), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_SistemaCAS_v18);
  return c6_y;
}
...
void sf_c6_SistemaCAS_v18_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(958441606U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4186611188U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3143882768U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2424305331U);
}

mxArray *sf_c6_SistemaCAS_v18_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("MDgOk3CWm3DxOQmcEGPE3G");
...
mxArray *sf_c6_SistemaCAS_v18_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_SistemaCAS_v18_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_SistemaCAS_v18(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ruido_total\",},{M[8],M[0],T\"is_active_c6_SistemaCAS_v18\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_SistemaCAS_v18_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_SistemaCAS_v18InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2051);
...
{
  return "vEEdRVvEuMe0aThahZQKo";
}

static void sf_opaque_initialize_c6_SistemaCAS_v18(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_SistemaCAS_v18InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*)
    chartInstanceVar);
  initialize_c6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_SistemaCAS_v18(void *chartInstanceVar)
{
  enable_c6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_SistemaCAS_v18(void *chartInstanceVar)
{
  disable_c6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_SistemaCAS_v18(void *chartInstanceVar)
{
  sf_gateway_c6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_SistemaCAS_v18(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_SistemaCAS_v18
    ((SFc6_SistemaCAS_v18InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_SistemaCAS_v18();/* state var info */
...
extern void sf_internal_set_sim_state_c6_SistemaCAS_v18(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_SistemaCAS_v18();/* state var info */
  ...
  set_sim_state_c6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_SistemaCAS_v18(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_SistemaCAS_v18(S);
}

static void sf_opaque_set_sim_state_c6_SistemaCAS_v18(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_SistemaCAS_v18(S, st);
}

static void sf_opaque_terminate_c6_SistemaCAS_v18(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_SistemaCAS_v18InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_SistemaCAS_v18((SFc6_SistemaCAS_v18InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_SistemaCAS_v18(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_SistemaCAS_v18(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(388317163U));
  ssSetChecksum1(S,(228859117U));
  ssSetChecksum2(S,(4165328973U));
  ssSetChecksum3(S,(96868614U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_SistemaCAS_v18(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_SistemaCAS_v18(SimStruct *S)
{
  SFc6_SistemaCAS_v18InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_SistemaCAS_v18InstanceStruct *)utMalloc(sizeof
    (SFc6_SistemaCAS_v18InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_SistemaCAS_v18InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_SistemaCAS_v18;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_SistemaCAS_v18;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_SistemaCAS_v18;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_SistemaCAS_v18;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_SistemaCAS_v18;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_SistemaCAS_v18;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_SistemaCAS_v18;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_SistemaCAS_v18;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_SistemaCAS_v18;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_SistemaCAS_v18;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_SistemaCAS_v18;
...
void c6_SistemaCAS_v18_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_SistemaCAS_v18(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_SistemaCAS_v18(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_SistemaCAS_v18(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_SistemaCAS_v18_method_dispatcher.\n"
