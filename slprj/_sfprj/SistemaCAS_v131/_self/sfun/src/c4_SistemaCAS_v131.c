...
static const char * c4_debug_family_names[8] = { "espalhamento3", "espmag",
  "nargin", "nargout", "k", "sinal_atrasado3", "caminhos", "sinal_espalhado3" };

/* Function Declarations */
static void initialize_c4_SistemaCAS_v131(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void initialize_params_c4_SistemaCAS_v131
  (SFc4_SistemaCAS_v131InstanceStruct *chartInstance);
static void enable_c4_SistemaCAS_v131(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void disable_c4_SistemaCAS_v131(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_SistemaCAS_v131
  (SFc4_SistemaCAS_v131InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_SistemaCAS_v131
  (SFc4_SistemaCAS_v131InstanceStruct *chartInstance);
static void set_sim_state_c4_SistemaCAS_v131(SFc4_SistemaCAS_v131InstanceStruct *
  chartInstance, const mxArray *c4_st);
static void finalize_c4_SistemaCAS_v131(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void sf_gateway_c4_SistemaCAS_v131(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void initSimStructsc4_SistemaCAS_v131(SFc4_SistemaCAS_v131InstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c4_sinal_espalhado3, const char_T
  *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_SistemaCAS_v131InstanceStruct
...
static void c4_eml_error(SFc4_SistemaCAS_v131InstanceStruct *chartInstance);
static real_T c4_power(SFc4_SistemaCAS_v131InstanceStruct *chartInstance, real_T
  c4_a, real_T c4_b);
static void c4_eml_scalar_eg(SFc4_SistemaCAS_v131InstanceStruct *chartInstance);
static void c4_b_eml_error(SFc4_SistemaCAS_v131InstanceStruct *chartInstance);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_SistemaCAS_v131, const char_T
  *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_SistemaCAS_v131InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_SistemaCAS_v131 = 0U;
}
  ...
  (SFc4_SistemaCAS_v131InstanceStruct *chartInstance)
{
  ...
  c4_sinal_espalhado3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellmatrix(2, 1), false);
  c4_hoistedGlobal = *c4_sinal_espalhado3;
  c4_u = c4_hoistedGlobal;
  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", &c4_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c4_y, 0, c4_b_y);
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_SistemaCAS_v131;
  ...
  chartInstance, const mxArray *c4_st)
{
  ...
  *c4_sinal_espalhado3 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 0)), "sinal_espalhado3");
  chartInstance->c4_is_active_c4_SistemaCAS_v131 = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_SistemaCAS_v131");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_SistemaCAS_v131(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c4_b;
  real_T c4_c;
  real_T *c4_b_caminhos;
  real_T *c4_b_sinal_atrasado3;
  real_T *c4_b_k;
  real_T *c4_b_sinal_espalhado3;
  c4_b_caminhos = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c4_b_sinal_espalhado3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_sinal_atrasado3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_k = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c4_b_k, 0U);
  _SFD_DATA_RANGE_CHECK(*c4_b_sinal_atrasado3, 1U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *c4_b_k;
  c4_b_hoistedGlobal = *c4_b_sinal_atrasado3;
  c4_c_hoistedGlobal = *c4_b_caminhos;
  c4_k = c4_hoistedGlobal;
  c4_sinal_atrasado3 = c4_b_hoistedGlobal;
  c4_caminhos = c4_c_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 8U, 8U, c4_debug_family_names,
    c4_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_espalhamento3, 0U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_espmag, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_sinal_atrasado3, 5U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_caminhos, 6U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_sinal_espalhado3, 7U,
  ...
  c4_b_x = muDoubleScalarLog10(c4_b_x);
  c4_espalhamento3 = -c4_k * 10.0 * c4_b_x;
  sf_mex_printf("%s =\\n", "espalhamento3");
  c4_u = c4_espalhamento3;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_create("y", &c4_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c4_y);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 26);
  c4_ydb = c4_espalhamento3;
  c4_A = c4_ydb;
  c4_c_x = c4_A;
  c4_d_x = c4_c_x;
  c4_e_x = c4_d_x;
  c4_b_y = c4_e_x / 20.0;
  c4_espmag = c4_power(chartInstance, 10.0, c4_b_y);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 31);
  c4_b_A = c4_espalhamento3;
  c4_f_x = c4_b_A;
  c4_g_x = c4_f_x;
  c4_h_x = c4_g_x;
  c4_c_y = c4_h_x / 10.0;
  c4_b = c4_c_y;
  c4_c = c4_power(chartInstance, 10.0, c4_b);
  c4_sinal_espalhado3 = c4_sinal_atrasado3 * c4_c;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -31);
  ...
  *c4_b_sinal_espalhado3 = c4_sinal_espalhado3;
  ...
  _SFD_DATA_RANGE_CHECK(*c4_b_sinal_espalhado3, 2U);
  _SFD_DATA_RANGE_CHECK(*c4_b_caminhos, 3U);
}
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_SistemaCAS_v131InstanceStruct *chartInstance;
  chartInstance = (SFc4_SistemaCAS_v131InstanceStruct *)chartInstanceVoid;
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_sinal_espalhado3),
    &c4_thisId);
  sf_mex_destroy(&c4_sinal_espalhado3);
  return c4_y;
}
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_sinal_espalhado3;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_SistemaCAS_v131InstanceStruct *chartInstance;
  chartInstance = (SFc4_SistemaCAS_v131InstanceStruct *)chartInstanceVoid;
  c4_sinal_espalhado3 = sf_mex_dup(c4_mxArrayInData);
...
const mxArray *sf_c4_SistemaCAS_v131_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("db2mag"), "name", "name", 13);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/controllib/general/db2mag.m"), "resolved",
                  "resolved", 13);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1381346356U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/controllib/general/db2mag.m"), "context",
                  "context", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mrdivide"), "name", "name", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 21);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("floor"), "name", "name", 21);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mrdivide"), "name", "name", 26);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mpower"), "name", "name", 27);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 29);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("ismatrix"), "name", "name", 29);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 30);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("power"), "name", "name", 30);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
...
static void c4_b_eml_error(SFc4_SistemaCAS_v131InstanceStruct *chartInstance)
{
  ...
  const mxArray *c4_y = NULL;
  (void)chartInstance;
  for (c4_i2 = 0; c4_i2 < 31; c4_i2++) {
    c4_u[c4_i2] = c4_cv2[c4_i2];
  }
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_SistemaCAS_v131), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_SistemaCAS_v131);
  return c4_y;
}
...
void sf_c4_SistemaCAS_v131_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2911379699U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2334041290U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3070366883U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4000476686U);
}

mxArray *sf_c4_SistemaCAS_v131_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("AUYegMtn1L1y39LLBk8aJ");
...
mxArray *sf_c4_SistemaCAS_v131_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_SistemaCAS_v131_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_SistemaCAS_v131(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[12],T\"sinal_espalhado3\",},{M[8],M[0],T\"is_active_c4_SistemaCAS_v131\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_SistemaCAS_v131_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_SistemaCAS_v131InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"sinal_atrasado3");
          _SFD_SET_DATA_PROPS(2,2,0,1,"sinal_espalhado3");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1647);
...

        {
          ...
          real_T *c4_sinal_espalhado3;
          real_T *c4_caminhos;
          c4_caminhos = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, c4_sinal_atrasado3);
          _SFD_SET_DATA_VALUE_PTR(2U, c4_sinal_espalhado3);
          _SFD_SET_DATA_VALUE_PTR(3U, c4_caminhos);
        }
      }
    } else {
...
{
  return "MkMm45JRQn3iMiyT768wME";
}

static void sf_opaque_initialize_c4_SistemaCAS_v131(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
  initialize_c4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_SistemaCAS_v131(void *chartInstanceVar)
{
  enable_c4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_SistemaCAS_v131(void *chartInstanceVar)
{
  disable_c4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_SistemaCAS_v131(void *chartInstanceVar)
{
  sf_gateway_c4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_SistemaCAS_v131(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_SistemaCAS_v131
    ((SFc4_SistemaCAS_v131InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v131();/* state var info */
...
extern void sf_internal_set_sim_state_c4_SistemaCAS_v131(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v131();/* state var info */
  ...
  set_sim_state_c4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_SistemaCAS_v131(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_SistemaCAS_v131(S);
}

static void sf_opaque_set_sim_state_c4_SistemaCAS_v131(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_SistemaCAS_v131(S, st);
}

static void sf_opaque_terminate_c4_SistemaCAS_v131(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_SistemaCAS_v131InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_SistemaCAS_v131((SFc4_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_SistemaCAS_v131(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_SistemaCAS_v131(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3923757968U));
  ssSetChecksum1(S,(4043239361U));
  ssSetChecksum2(S,(1870245997U));
  ssSetChecksum3(S,(2926821537U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_SistemaCAS_v131(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_SistemaCAS_v131(SimStruct *S)
{
  SFc4_SistemaCAS_v131InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_SistemaCAS_v131InstanceStruct *)utMalloc(sizeof
    (SFc4_SistemaCAS_v131InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_SistemaCAS_v131InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_SistemaCAS_v131;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_SistemaCAS_v131;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_SistemaCAS_v131;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_SistemaCAS_v131;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_SistemaCAS_v131;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_SistemaCAS_v131;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_SistemaCAS_v131;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_SistemaCAS_v131;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_SistemaCAS_v131;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_SistemaCAS_v131;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_SistemaCAS_v131;
...
void c4_SistemaCAS_v131_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_SistemaCAS_v131(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_SistemaCAS_v131(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_SistemaCAS_v131(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_SistemaCAS_v131_method_dispatcher.\n"
