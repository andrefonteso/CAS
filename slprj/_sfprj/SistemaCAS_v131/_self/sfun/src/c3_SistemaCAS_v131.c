...
#include <stddef.h>
#include "blas.h"
#include "SistemaCAS_v131_sfun.h"
#include "c3_SistemaCAS_v131.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "SistemaCAS_v131_sfun_debug_macros.h"
...
static const char * c3_debug_family_names[17] = { "T", "S", "pH", "D", "f1",
  "f2", "a", "atenuacao3", "sinal_atenuado3", "nargin", "nargout",
  "parametros_aquario", "parametros_ambientais", "frequencia",
  "sinal_espalhado3", "caminhos", "sinal_atenuado_total" };

/* Function Declarations */
static void initialize_c3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void initialize_params_c3_SistemaCAS_v131
  (SFc3_SistemaCAS_v131InstanceStruct *chartInstance);
static void enable_c3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void disable_c3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_SistemaCAS_v131
  (SFc3_SistemaCAS_v131InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_SistemaCAS_v131
  (SFc3_SistemaCAS_v131InstanceStruct *chartInstance);
static void set_sim_state_c3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct *
  chartInstance, const mxArray *c3_st);
static void finalize_c3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void sf_gateway_c3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance);
static void initSimStructsc3_SistemaCAS_v131(SFc3_SistemaCAS_v131InstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c3_sinal_atenuado_total, const char_T
  *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_SistemaCAS_v131InstanceStruct
...
static real_T c3_sqrt(SFc3_SistemaCAS_v131InstanceStruct *chartInstance, real_T
                      c3_x);
static void c3_eml_error(SFc3_SistemaCAS_v131InstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_SistemaCAS_v131InstanceStruct *chartInstance,
  real_T c3_a);
static void c3_eml_scalar_eg(SFc3_SistemaCAS_v131InstanceStruct *chartInstance);
static void c3_b_eml_error(SFc3_SistemaCAS_v131InstanceStruct *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_SistemaCAS_v131, const char_T
  *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sqrt(SFc3_SistemaCAS_v131InstanceStruct *chartInstance, real_T *
                      c3_x);
static void init_dsm_address_info(SFc3_SistemaCAS_v131InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_SistemaCAS_v131 = 0U;
}
  ...
  (SFc3_SistemaCAS_v131InstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_SistemaCAS_v131;
  ...
  chartInstance, const mxArray *c3_st)
{
  ...
  *c3_sinal_atenuado_total = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_SistemaCAS_v131 = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_SistemaCAS_v131");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_SistemaCAS_v131(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_SistemaCAS_v131(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v131MachineNumber_,
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacao3, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado3, 8U,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_parametros_ambientais, 12U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_frequencia, 13U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado3, 14U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_caminhos, 15U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado_total, 16U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_tb_x = muDoubleScalarLog10(c3_tb_x);
  c3_atenuacao3 = -10.0 * c3_tb_x * c3_caminhos;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 49);
  c3_l_A = c3_atenuacao3;
  c3_ub_x = c3_l_A;
  c3_vb_x = c3_ub_x;
  c3_wb_x = c3_vb_x;
  c3_r_y = c3_wb_x / 10.0;
  ...
  c3_eml_scalar_eg(chartInstance);
  c3_br = c3_d_b;
  c3_c = muDoubleScalarPower(10.0, c3_br);
  c3_sinal_atenuado3 = c3_sinal_espalhado3 * c3_c;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_SistemaCAS_v131InstanceStruct *chartInstance;
  chartInstance = (SFc3_SistemaCAS_v131InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_SistemaCAS_v131_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_SistemaCAS_v131), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_SistemaCAS_v131);
  return c3_y;
}
...
void sf_c3_SistemaCAS_v131_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1998272664U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2220987297U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1676907669U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1856939823U);
}

mxArray *sf_c3_SistemaCAS_v131_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("rZ97XoybN2bKak8G6XLCOD");
...
mxArray *sf_c3_SistemaCAS_v131_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_SistemaCAS_v131_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_SistemaCAS_v131(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[20],T\"sinal_atenuado_total\",},{M[8],M[0],T\"is_active_c3_SistemaCAS_v131\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_SistemaCAS_v131_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SistemaCAS_v131InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _SistemaCAS_v131MachineNumber_,
           3,
           1,
           1,
           0,
        ...
        init_script_number_translation(_SistemaCAS_v131MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_SistemaCAS_v131MachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2100);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _SistemaCAS_v131MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "qx4XugCPzsQlCjIGWqQQcB";
}

static void sf_opaque_initialize_c3_SistemaCAS_v131(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
  initialize_c3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_SistemaCAS_v131(void *chartInstanceVar)
{
  enable_c3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_SistemaCAS_v131(void *chartInstanceVar)
{
  disable_c3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_SistemaCAS_v131(void *chartInstanceVar)
{
  sf_gateway_c3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_SistemaCAS_v131(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_SistemaCAS_v131
    ((SFc3_SistemaCAS_v131InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v131();/* state var info */
...
extern void sf_internal_set_sim_state_c3_SistemaCAS_v131(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v131();/* state var info */
  ...
  set_sim_state_c3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_SistemaCAS_v131(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_SistemaCAS_v131(S);
}

static void sf_opaque_set_sim_state_c3_SistemaCAS_v131(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_SistemaCAS_v131(S, st);
}

static void sf_opaque_terminate_c3_SistemaCAS_v131(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_SistemaCAS_v131InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SistemaCAS_v131_optimization_info();
    }

    finalize_c3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_SistemaCAS_v131((SFc3_SistemaCAS_v131InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_SistemaCAS_v131(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_SistemaCAS_v131(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_SistemaCAS_v131_optimization_info();
  ...
  ssSetChecksum0(S,(3340583456U));
  ssSetChecksum1(S,(1564039226U));
  ssSetChecksum2(S,(3077665695U));
  ssSetChecksum3(S,(4051704210U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_SistemaCAS_v131(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_SistemaCAS_v131(SimStruct *S)
{
  SFc3_SistemaCAS_v131InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_SistemaCAS_v131InstanceStruct *)utMalloc(sizeof
    (SFc3_SistemaCAS_v131InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_SistemaCAS_v131InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_SistemaCAS_v131;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_SistemaCAS_v131;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_SistemaCAS_v131;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_SistemaCAS_v131;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_SistemaCAS_v131;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_SistemaCAS_v131;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_SistemaCAS_v131;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_SistemaCAS_v131;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_SistemaCAS_v131;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_SistemaCAS_v131;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_SistemaCAS_v131;
...
void c3_SistemaCAS_v131_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_SistemaCAS_v131(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_SistemaCAS_v131(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_SistemaCAS_v131(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_SistemaCAS_v131_method_dispatcher.\n"
