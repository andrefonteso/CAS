...
static const char * c1_debug_family_names[59] = { "f1", "f2", "cmetro", "c",
  ...
  "ab7", "sp1", "sp2", "sp3", "sp4", "sp5", "sp6", "sp7", "agT", "nargin",
  "nargout", "f", "rr", "T", "D", "S", "pH", "r", "L1", "L2", "ag2", "L3", "ag3",
...
static void initialize_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
static void initialize_params_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct *
  chartInstance);
static void enable_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
static void disable_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_SistemaCAS_v4
  (SFc1_SistemaCAS_v4InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_SistemaCAS_v4
  (SFc1_SistemaCAS_v4InstanceStruct *chartInstance);
static void set_sim_state_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
static void sf_gateway_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
static void c1_chartstep_c1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
static void initSimStructsc1_SistemaCAS_v4(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance, const mxArray *c1_atraso7, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_SistemaCAS_v4InstanceStruct
...
static real_T c1_sqrt(SFc1_SistemaCAS_v4InstanceStruct *chartInstance, real_T
                      c1_x);
static void c1_eml_error(SFc1_SistemaCAS_v4InstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_SistemaCAS_v4InstanceStruct *chartInstance);
static real_T c1_mpower(SFc1_SistemaCAS_v4InstanceStruct *chartInstance, real_T
  c1_a);
static real_T c1_b_mpower(SFc1_SistemaCAS_v4InstanceStruct *chartInstance,
  real_T c1_a);
static real_T c1_asin(SFc1_SistemaCAS_v4InstanceStruct *chartInstance, real_T
                      c1_x);
static void c1_b_eml_error(SFc1_SistemaCAS_v4InstanceStruct *chartInstance);
static real_T c1_log10(SFc1_SistemaCAS_v4InstanceStruct *chartInstance, real_T
  c1_x);
static void c1_c_eml_error(SFc1_SistemaCAS_v4InstanceStruct *chartInstance);
static real_T c1_c_mpower(SFc1_SistemaCAS_v4InstanceStruct *chartInstance,
  real_T c1_a, real_T c1_b);
static void c1_d_eml_error(SFc1_SistemaCAS_v4InstanceStruct *chartInstance);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_SistemaCAS_v4, const char_T
  *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sqrt(SFc1_SistemaCAS_v4InstanceStruct *chartInstance, real_T
                      *c1_x);
static void c1_b_asin(SFc1_SistemaCAS_v4InstanceStruct *chartInstance, real_T
                      *c1_x);
static void c1_b_log10(SFc1_SistemaCAS_v4InstanceStruct *chartInstance, real_T
  *c1_x);
static void init_dsm_address_info(SFc1_SistemaCAS_v4InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_SistemaCAS_v4 = 0U;
}
  ...
  (SFc1_SistemaCAS_v4InstanceStruct *chartInstance)
{
  ...
  c1_o_hoistedGlobal = chartInstance->c1_is_active_c1_SistemaCAS_v4;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_sinal7 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    13)), "sinal7");
  chartInstance->c1_is_active_c1_SistemaCAS_v4 = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 14)),
     "is_active_c1_SistemaCAS_v4");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_SistemaCAS_v4(chartInstance);
  ...
  *chartInstance)
{
  ...
  c1_sinal2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c1_atraso1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_sps = (real_T *)ssGetInputPortSignal(chartInstance->S, 18);
  c1_L7 = (real_T *)ssGetInputPortSignal(chartInstance->S, 17);
  c1_L6 = (real_T *)ssGetInputPortSignal(chartInstance->S, 16);
  c1_ag5 = (real_T *)ssGetInputPortSignal(chartInstance->S, 15);
  c1_L5 = (real_T *)ssGetInputPortSignal(chartInstance->S, 14);
  c1_ag4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 13);
  c1_L4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 12);
  c1_ag3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 11);
  c1_L3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c1_ag2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  c1_L2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 8);
  c1_L1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 7);
  c1_sinal1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_r = (real_T *)ssGetInputPortSignal(chartInstance->S, 6);
  c1_pH = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c1_S = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c1_D = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c1_T = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_rr = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c1_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c1_f, 0U);
  _SFD_DATA_RANGE_CHECK(*c1_rr, 1U);
  _SFD_DATA_RANGE_CHECK(*c1_T, 2U);
  _SFD_DATA_RANGE_CHECK(*c1_D, 3U);
  _SFD_DATA_RANGE_CHECK(*c1_S, 4U);
  _SFD_DATA_RANGE_CHECK(*c1_pH, 5U);
  _SFD_DATA_RANGE_CHECK(*c1_r, 6U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_SistemaCAS_v4(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v4MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c1_sinal1, 7U);
  _SFD_DATA_RANGE_CHECK(*c1_L1, 8U);
  _SFD_DATA_RANGE_CHECK(*c1_L2, 9U);
  _SFD_DATA_RANGE_CHECK(*c1_ag2, 10U);
  _SFD_DATA_RANGE_CHECK(*c1_L3, 11U);
  _SFD_DATA_RANGE_CHECK(*c1_ag3, 12U);
  _SFD_DATA_RANGE_CHECK(*c1_L4, 13U);
  _SFD_DATA_RANGE_CHECK(*c1_ag4, 14U);
  _SFD_DATA_RANGE_CHECK(*c1_L5, 15U);
  _SFD_DATA_RANGE_CHECK(*c1_ag5, 16U);
  _SFD_DATA_RANGE_CHECK(*c1_L6, 17U);
  _SFD_DATA_RANGE_CHECK(*c1_L7, 18U);
  _SFD_DATA_RANGE_CHECK(*c1_sps, 19U);
  _SFD_DATA_RANGE_CHECK(*c1_atraso1, 20U);
  _SFD_DATA_RANGE_CHECK(*c1_sinal2, 21U);
  _SFD_DATA_RANGE_CHECK(*c1_atraso2, 22U);
  _SFD_DATA_RANGE_CHECK(*c1_sinal3, 23U);
  _SFD_DATA_RANGE_CHECK(*c1_atraso3, 24U);
  _SFD_DATA_RANGE_CHECK(*c1_sinal4, 25U);
  _SFD_DATA_RANGE_CHECK(*c1_atraso4, 26U);
  _SFD_DATA_RANGE_CHECK(*c1_sinal5, 27U);
  _SFD_DATA_RANGE_CHECK(*c1_atraso5, 28U);
  _SFD_DATA_RANGE_CHECK(*c1_sinal6, 29U);
  _SFD_DATA_RANGE_CHECK(*c1_atraso6, 30U);
  _SFD_DATA_RANGE_CHECK(*c1_sinal7, 31U);
  _SFD_DATA_RANGE_CHECK(*c1_atraso7, 32U);
}
  ...
  *chartInstance)
{
  ...
  c1_b_sps = (real_T *)ssGetInputPortSignal(chartInstance->S, 18);
  c1_b_L7 = (real_T *)ssGetInputPortSignal(chartInstance->S, 17);
  c1_b_L6 = (real_T *)ssGetInputPortSignal(chartInstance->S, 16);
  c1_b_ag5 = (real_T *)ssGetInputPortSignal(chartInstance->S, 15);
  c1_b_L5 = (real_T *)ssGetInputPortSignal(chartInstance->S, 14);
  c1_b_ag4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 13);
  c1_b_L4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 12);
  c1_b_ag3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 11);
  c1_b_L3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c1_b_ag2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  c1_b_L2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 8);
  c1_b_L1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 7);
  c1_b_sinal1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_r = (real_T *)ssGetInputPortSignal(chartInstance->S, 6);
  c1_b_pH = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c1_b_S = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c1_b_D = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c1_b_T = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_rr = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c1_b_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_hoistedGlobal = *c1_b_f;
  c1_b_hoistedGlobal = *c1_b_rr;
  c1_c_hoistedGlobal = *c1_b_T;
  c1_d_hoistedGlobal = *c1_b_D;
  c1_e_hoistedGlobal = *c1_b_S;
  c1_f_hoistedGlobal = *c1_b_pH;
  c1_g_hoistedGlobal = *c1_b_r;
  c1_h_hoistedGlobal = *c1_b_L1;
  c1_i_hoistedGlobal = *c1_b_L2;
  c1_j_hoistedGlobal = *c1_b_ag2;
  c1_k_hoistedGlobal = *c1_b_L3;
  c1_l_hoistedGlobal = *c1_b_ag3;
  c1_m_hoistedGlobal = *c1_b_L4;
  c1_n_hoistedGlobal = *c1_b_ag4;
  c1_o_hoistedGlobal = *c1_b_L5;
  c1_p_hoistedGlobal = *c1_b_ag5;
  c1_q_hoistedGlobal = *c1_b_L6;
  c1_r_hoistedGlobal = *c1_b_L7;
  c1_s_hoistedGlobal = *c1_b_sps;
  c1_f = c1_hoistedGlobal;
  c1_rr = c1_b_hoistedGlobal;
  c1_T = c1_c_hoistedGlobal;
  c1_D = c1_d_hoistedGlobal;
  c1_S = c1_e_hoistedGlobal;
  c1_pH = c1_f_hoistedGlobal;
  c1_r = c1_g_hoistedGlobal;
  c1_L1 = c1_h_hoistedGlobal;
  c1_L2 = c1_i_hoistedGlobal;
  c1_ag2 = c1_j_hoistedGlobal;
  c1_L3 = c1_k_hoistedGlobal;
  c1_ag3 = c1_l_hoistedGlobal;
  c1_L4 = c1_m_hoistedGlobal;
  c1_ag4 = c1_n_hoistedGlobal;
  c1_L5 = c1_o_hoistedGlobal;
  c1_ag5 = c1_p_hoistedGlobal;
  c1_L6 = c1_q_hoistedGlobal;
  c1_L7 = c1_r_hoistedGlobal;
  c1_sps = c1_s_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_sp7, 22U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_agT, 23U, c1_sf_marshallOut,
    c1_sf_marshallIn);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_SistemaCAS_v4InstanceStruct *chartInstance;
  chartInstance = (SFc1_SistemaCAS_v4InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_SistemaCAS_v4_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_SistemaCAS_v4), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_SistemaCAS_v4);
  return c1_y;
}
...
void sf_c1_SistemaCAS_v4_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1270891513U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1105840803U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(604223347U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3431219528U);
}

mxArray *sf_c1_SistemaCAS_v4_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VE0NV655ppExXAevjbQbAB");
...
mxArray *sf_c1_SistemaCAS_v4_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_SistemaCAS_v4_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_SistemaCAS_v4(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[29],T\"sinal4\",},{M[1],M[31],T\"sinal5\",},{M[1],M[33],T\"sinal6\",},{M[1],M[35],T\"sinal7\",},{M[8],M[0],T\"is_active_c1_SistemaCAS_v4\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 15, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_SistemaCAS_v4_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_SistemaCAS_v4InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"rr");
          _SFD_SET_DATA_PROPS(2,1,1,0,"T");
          _SFD_SET_DATA_PROPS(3,1,1,0,"D");
          _SFD_SET_DATA_PROPS(4,1,1,0,"S");
          _SFD_SET_DATA_PROPS(5,1,1,0,"pH");
          _SFD_SET_DATA_PROPS(6,1,1,0,"r");
          _SFD_SET_DATA_PROPS(7,2,0,1,"sinal1");
          _SFD_SET_DATA_PROPS(8,1,1,0,"L1");
          _SFD_SET_DATA_PROPS(9,1,1,0,"L2");
          _SFD_SET_DATA_PROPS(10,1,1,0,"ag2");
          _SFD_SET_DATA_PROPS(11,1,1,0,"L3");
          _SFD_SET_DATA_PROPS(12,1,1,0,"ag3");
          _SFD_SET_DATA_PROPS(13,1,1,0,"L4");
          _SFD_SET_DATA_PROPS(14,1,1,0,"ag4");
          _SFD_SET_DATA_PROPS(15,1,1,0,"L5");
          _SFD_SET_DATA_PROPS(16,1,1,0,"ag5");
          _SFD_SET_DATA_PROPS(17,1,1,0,"L6");
          _SFD_SET_DATA_PROPS(18,1,1,0,"L7");
          _SFD_SET_DATA_PROPS(19,1,1,0,"sps");
          _SFD_SET_DATA_PROPS(20,2,0,1,"atraso1");
          _SFD_SET_DATA_PROPS(21,2,0,1,"sinal2");
          _SFD_SET_DATA_PROPS(22,2,0,1,"atraso2");
          _SFD_SET_DATA_PROPS(23,2,0,1,"sinal3");
          _SFD_SET_DATA_PROPS(24,2,0,1,"atraso3");
          _SFD_SET_DATA_PROPS(25,2,0,1,"sinal4");
          _SFD_SET_DATA_PROPS(26,2,0,1,"atraso4");
          _SFD_SET_DATA_PROPS(27,2,0,1,"sinal5");
          _SFD_SET_DATA_PROPS(28,2,0,1,"atraso5");
          _SFD_SET_DATA_PROPS(29,2,0,1,"sinal6");
          _SFD_SET_DATA_PROPS(30,2,0,1,"atraso6");
          _SFD_SET_DATA_PROPS(31,2,0,1,"sinal7");
          _SFD_SET_DATA_PROPS(32,2,0,1,"atraso7");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",40,-1,2337);
        _SFD_CV_INIT_EML_IF(0,1,0,1151,1165,-1,1189);
        _SFD_CV_INIT_EML_IF(0,1,1,1190,1204,-1,1238);
        _SFD_CV_INIT_EML_IF(0,1,2,2128,2137,-1,2215);
        _SFD_CV_INIT_EML_IF(0,1,3,2216,2225,-1,2303);
...

        {
          ...
          c1_rr = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c1_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c1_f);
          _SFD_SET_DATA_VALUE_PTR(1U, c1_rr);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_T);
          _SFD_SET_DATA_VALUE_PTR(3U, c1_D);
          _SFD_SET_DATA_VALUE_PTR(4U, c1_S);
          _SFD_SET_DATA_VALUE_PTR(5U, c1_pH);
          _SFD_SET_DATA_VALUE_PTR(6U, c1_r);
          _SFD_SET_DATA_VALUE_PTR(7U, c1_sinal1);
          _SFD_SET_DATA_VALUE_PTR(8U, c1_L1);
          _SFD_SET_DATA_VALUE_PTR(9U, c1_L2);
          _SFD_SET_DATA_VALUE_PTR(10U, c1_ag2);
          _SFD_SET_DATA_VALUE_PTR(11U, c1_L3);
          _SFD_SET_DATA_VALUE_PTR(12U, c1_ag3);
          _SFD_SET_DATA_VALUE_PTR(13U, c1_L4);
          _SFD_SET_DATA_VALUE_PTR(14U, c1_ag4);
          _SFD_SET_DATA_VALUE_PTR(15U, c1_L5);
          _SFD_SET_DATA_VALUE_PTR(16U, c1_ag5);
          _SFD_SET_DATA_VALUE_PTR(17U, c1_L6);
          _SFD_SET_DATA_VALUE_PTR(18U, c1_L7);
          _SFD_SET_DATA_VALUE_PTR(19U, c1_sps);
          _SFD_SET_DATA_VALUE_PTR(20U, c1_atraso1);
          _SFD_SET_DATA_VALUE_PTR(21U, c1_sinal2);
          _SFD_SET_DATA_VALUE_PTR(22U, c1_atraso2);
          _SFD_SET_DATA_VALUE_PTR(23U, c1_sinal3);
          _SFD_SET_DATA_VALUE_PTR(24U, c1_atraso3);
          _SFD_SET_DATA_VALUE_PTR(25U, c1_sinal4);
          _SFD_SET_DATA_VALUE_PTR(26U, c1_atraso4);
          _SFD_SET_DATA_VALUE_PTR(27U, c1_sinal5);
          _SFD_SET_DATA_VALUE_PTR(28U, c1_atraso5);
          _SFD_SET_DATA_VALUE_PTR(29U, c1_sinal6);
          _SFD_SET_DATA_VALUE_PTR(30U, c1_atraso6);
          _SFD_SET_DATA_VALUE_PTR(31U, c1_sinal7);
          _SFD_SET_DATA_VALUE_PTR(32U, c1_atraso7);
        }
      }
    } else {
...
{
  return "Id8yMLNwKXuE9XW13cu4E";
}

static void sf_opaque_initialize_c1_SistemaCAS_v4(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_SistemaCAS_v4InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*)
    chartInstanceVar);
  initialize_c1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_SistemaCAS_v4(void *chartInstanceVar)
{
  enable_c1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_SistemaCAS_v4(void *chartInstanceVar)
{
  disable_c1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_SistemaCAS_v4(void *chartInstanceVar)
{
  sf_gateway_c1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_SistemaCAS_v4(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_SistemaCAS_v4
    ((SFc1_SistemaCAS_v4InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_SistemaCAS_v4();/* state var info */
...
extern void sf_internal_set_sim_state_c1_SistemaCAS_v4(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_SistemaCAS_v4();/* state var info */
  ...
  set_sim_state_c1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_SistemaCAS_v4(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_SistemaCAS_v4(S);
}

static void sf_opaque_set_sim_state_c1_SistemaCAS_v4(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_SistemaCAS_v4(S, st);
}

static void sf_opaque_terminate_c1_SistemaCAS_v4(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_SistemaCAS_v4InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_SistemaCAS_v4((SFc1_SistemaCAS_v4InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_SistemaCAS_v4(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_SistemaCAS_v4(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1639287343U));
  ssSetChecksum1(S,(597287590U));
  ssSetChecksum2(S,(1583789583U));
  ssSetChecksum3(S,(2948208987U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_SistemaCAS_v4(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_SistemaCAS_v4(SimStruct *S)
{
  SFc1_SistemaCAS_v4InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_SistemaCAS_v4InstanceStruct *)utMalloc(sizeof
    (SFc1_SistemaCAS_v4InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_SistemaCAS_v4InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_SistemaCAS_v4;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_SistemaCAS_v4;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_SistemaCAS_v4;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_SistemaCAS_v4;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_SistemaCAS_v4;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_SistemaCAS_v4;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_SistemaCAS_v4;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_SistemaCAS_v4;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_SistemaCAS_v4;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_SistemaCAS_v4;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_SistemaCAS_v4;
...
void c1_SistemaCAS_v4_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_SistemaCAS_v4(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_SistemaCAS_v4(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_SistemaCAS_v4(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_SistemaCAS_v4_method_dispatcher.\n"
