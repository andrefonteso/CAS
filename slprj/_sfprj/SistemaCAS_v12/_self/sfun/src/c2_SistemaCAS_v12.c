...
static void initialize_c2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void initialize_params_c2_SistemaCAS_v12
  (SFc2_SistemaCAS_v12InstanceStruct *chartInstance);
static void enable_c2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void disable_c2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_SistemaCAS_v12
  (SFc2_SistemaCAS_v12InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SistemaCAS_v12
  (SFc2_SistemaCAS_v12InstanceStruct *chartInstance);
static void set_sim_state_c2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void sf_gateway_c2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void c2_chartstep_c2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void initSimStructsc2_SistemaCAS_v12(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_atraso5, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_caminhos, const char_T *c2_identifier,
  real_T c2_y[5]);
static void c2_d_emlrt_marshallIn(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[5]);
...
static real_T c2_mpower(SFc2_SistemaCAS_v12InstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_SistemaCAS_v12InstanceStruct *chartInstance);
static void c2_eml_error(SFc2_SistemaCAS_v12InstanceStruct *chartInstance);
static real_T c2_mean(SFc2_SistemaCAS_v12InstanceStruct *chartInstance, real_T
                      c2_x[2]);
static real_T c2_b_mpower(SFc2_SistemaCAS_v12InstanceStruct *chartInstance,
  real_T c2_a);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_SistemaCAS_v12, const char_T *
  c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_SistemaCAS_v12InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SistemaCAS_v12 = 0U;
}
  ...
  (SFc2_SistemaCAS_v12InstanceStruct *chartInstance)
{
  ...
  c2_f_hoistedGlobal = chartInstance->c2_is_active_c2_SistemaCAS_v12;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_atraso5 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_SistemaCAS_v12 = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 6)),
     "is_active_c2_SistemaCAS_v12");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SistemaCAS_v12(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_SistemaCAS_v12(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v12MachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SistemaCAS_v12InstanceStruct *chartInstance;
  chartInstance = (SFc2_SistemaCAS_v12InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_SistemaCAS_v12_get_eml_resolved_functions_info(void)
{
  ...
  c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SistemaCAS_v12), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SistemaCAS_v12);
  return c2_y;
}
...
void sf_c2_SistemaCAS_v12_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_SistemaCAS_v12_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_SistemaCAS_v12_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_SistemaCAS_v12_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_SistemaCAS_v12(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[10],T\"atraso1\",},{M[1],M[11],T\"atraso2\",},{M[1],M[12],T\"atraso3\",},{M[1],M[13],T\"atraso4\",},{M[1],M[14],T\"atraso5\",},{M[1],M[5],T\"caminhos\",},{M[8],M[0],T\"is_active_c2_SistemaCAS_v12\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SistemaCAS_v12_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_SistemaCAS_v12InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_SistemaCAS_v12MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_SistemaCAS_v12MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _SistemaCAS_v12MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c2_SistemaCAS_v12(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
  initialize_c2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_SistemaCAS_v12(void *chartInstanceVar)
{
  enable_c2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_SistemaCAS_v12(void *chartInstanceVar)
{
  disable_c2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_SistemaCAS_v12(void *chartInstanceVar)
{
  sf_gateway_c2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_SistemaCAS_v12(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SistemaCAS_v12
    ((SFc2_SistemaCAS_v12InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_SistemaCAS_v12();/* state var info */
...
extern void sf_internal_set_sim_state_c2_SistemaCAS_v12(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_SistemaCAS_v12();/* state var info */
  ...
  set_sim_state_c2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_SistemaCAS_v12(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SistemaCAS_v12(S);
}

static void sf_opaque_set_sim_state_c2_SistemaCAS_v12(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_SistemaCAS_v12(S, st);
}

static void sf_opaque_terminate_c2_SistemaCAS_v12(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SistemaCAS_v12InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SistemaCAS_v12_optimization_info();
    }

    finalize_c2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_SistemaCAS_v12((SFc2_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SistemaCAS_v12(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_SistemaCAS_v12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_SistemaCAS_v12_optimization_info();
...
static void mdlRTW_c2_SistemaCAS_v12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_SistemaCAS_v12(SimStruct *S)
{
  SFc2_SistemaCAS_v12InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_SistemaCAS_v12InstanceStruct *)utMalloc(sizeof
    (SFc2_SistemaCAS_v12InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_SistemaCAS_v12InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_SistemaCAS_v12;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SistemaCAS_v12;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_SistemaCAS_v12;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_SistemaCAS_v12;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_SistemaCAS_v12;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SistemaCAS_v12;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SistemaCAS_v12;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SistemaCAS_v12;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SistemaCAS_v12;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SistemaCAS_v12;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_SistemaCAS_v12;
...
void c2_SistemaCAS_v12_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SistemaCAS_v12(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SistemaCAS_v12(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SistemaCAS_v12(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SistemaCAS_v12_method_dispatcher.\n"
