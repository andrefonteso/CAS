...
static const char * c6_debug_family_names[13] = { "f", "Nt", "Ns", "Nw", "Nth",
  "nargin", "nargout", "sinal_atenuado", "frequencia", "n", "v", "ruido_total",
  "sinal_ruidoso" };

/* Function Declarations */
static void initialize_c6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void initialize_params_c6_SistemaCAS_v12
  (SFc6_SistemaCAS_v12InstanceStruct *chartInstance);
static void enable_c6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void disable_c6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_SistemaCAS_v12
  (SFc6_SistemaCAS_v12InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_SistemaCAS_v12
  (SFc6_SistemaCAS_v12InstanceStruct *chartInstance);
static void set_sim_state_c6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void sf_gateway_c6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void c6_chartstep_c6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void initSimStructsc6_SistemaCAS_v12(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c6_sinal_ruidoso, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_SistemaCAS_v12InstanceStruct
...
static real_T c6_log10(SFc6_SistemaCAS_v12InstanceStruct *chartInstance, real_T
  c6_x);
static void c6_eml_error(SFc6_SistemaCAS_v12InstanceStruct *chartInstance);
static real_T c6_mpower(SFc6_SistemaCAS_v12InstanceStruct *chartInstance, real_T
  c6_a, real_T c6_b);
static void c6_eml_scalar_eg(SFc6_SistemaCAS_v12InstanceStruct *chartInstance);
static void c6_b_eml_error(SFc6_SistemaCAS_v12InstanceStruct *chartInstance);
static void c6_c_eml_error(SFc6_SistemaCAS_v12InstanceStruct *chartInstance);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_SistemaCAS_v12, const char_T *
  c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_log10(SFc6_SistemaCAS_v12InstanceStruct *chartInstance, real_T *
  c6_x);
static void init_dsm_address_info(SFc6_SistemaCAS_v12InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_SistemaCAS_v12 = 0U;
}
  ...
  (SFc6_SistemaCAS_v12InstanceStruct *chartInstance)
{
  ...
  real_T *c6_sinal_ruidoso;
  c6_sinal_ruidoso = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  c6_b_hoistedGlobal = *c6_sinal_ruidoso;
  c6_b_u = c6_b_hoistedGlobal;
  c6_c_y = NULL;
  sf_mex_assign(&c6_c_y, sf_mex_create("y", &c6_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c6_y, 1, c6_c_y);
  c6_c_hoistedGlobal = chartInstance->c6_is_active_c6_SistemaCAS_v12;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  *c6_ruido_total = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 0)), "ruido_total");
  *c6_sinal_ruidoso = c6_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c6_u, 1)), "sinal_ruidoso");
  chartInstance->c6_is_active_c6_SistemaCAS_v12 = c6_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 2)),
     "is_active_c6_SistemaCAS_v12");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_SistemaCAS_v12(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T *c6_sinal_ruidoso;
  c6_sinal_ruidoso = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c6_v = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c6_n = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c6_ruido_total = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c6_frequencia = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c6_sinal_atenuado = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 5U, chartInstance->c6_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c6_sinal_atenuado, 0U);
  _SFD_DATA_RANGE_CHECK(*c6_frequencia, 1U);
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_SistemaCAS_v12(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v12MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c6_ruido_total, 2U);
  _SFD_DATA_RANGE_CHECK(*c6_n, 3U);
  _SFD_DATA_RANGE_CHECK(*c6_v, 4U);
  _SFD_DATA_RANGE_CHECK(*c6_sinal_ruidoso, 5U);
}
  ...
  *chartInstance)
{
  ...
  real_T c6_m_x;
  real_T c6_d_y;
  real_T *c6_b_sinal_ruidoso;
  real_T *c6_b_ruido_total;
  real_T *c6_b_v;
  real_T *c6_b_n;
  real_T *c6_b_frequencia;
  real_T *c6_b_sinal_atenuado;
  c6_b_sinal_ruidoso = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c6_b_v = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c6_b_n = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c6_b_ruido_total = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c6_b_frequencia = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c6_b_sinal_atenuado = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 5U, chartInstance->c6_sfEvent);
  c6_hoistedGlobal = *c6_b_sinal_atenuado;
  c6_b_hoistedGlobal = *c6_b_frequencia;
  c6_c_hoistedGlobal = *c6_b_n;
  c6_d_hoistedGlobal = *c6_b_v;
  c6_sinal_atenuado = c6_hoistedGlobal;
  c6_frequencia = c6_b_hoistedGlobal;
  c6_n = c6_c_hoistedGlobal;
  c6_v = c6_d_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 6U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_sinal_atenuado, 7U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_frequencia, 8U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_n, 9U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_v, 10U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_ruido_total, 11U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_sinal_ruidoso, 12U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c6_sinal_ruidoso = c6_sinal_atenuado + c6_ruido_total;
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -21);
  _SFD_SYMBOL_SCOPE_POP();
  *c6_b_ruido_total = c6_ruido_total;
  *c6_b_sinal_ruidoso = c6_sinal_ruidoso;
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_SistemaCAS_v12InstanceStruct *chartInstance;
  chartInstance = (SFc6_SistemaCAS_v12InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c6_sinal_ruidoso, const char_T *c6_identifier)
{
  ...
  c6_y = c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_sinal_ruidoso),
    &c6_thisId);
  sf_mex_destroy(&c6_sinal_ruidoso);
  return c6_y;
}
...
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  const mxArray *c6_sinal_ruidoso;
  const char_T *c6_identifier;
  emlrtMsgIdentifier c6_thisId;
  real_T c6_y;
  SFc6_SistemaCAS_v12InstanceStruct *chartInstance;
  chartInstance = (SFc6_SistemaCAS_v12InstanceStruct *)chartInstanceVoid;
  c6_sinal_ruidoso = sf_mex_dup(c6_mxArrayInData);
...
const mxArray *sf_c6_SistemaCAS_v12_get_eml_resolved_functions_info(void)
{
  ...
  c6_identifier)
{
  ...
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_SistemaCAS_v12), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_SistemaCAS_v12);
  return c6_y;
}
...
void sf_c6_SistemaCAS_v12_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2896325992U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3286414042U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4106419529U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3082472013U);
}

mxArray *sf_c6_SistemaCAS_v12_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("LYM9N549GgeIxbFplvlL9F");
...
mxArray *sf_c6_SistemaCAS_v12_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_SistemaCAS_v12_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_SistemaCAS_v12(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"ruido_total\",},{M[1],M[12],T\"sinal_ruidoso\",},{M[8],M[0],T\"is_active_c6_SistemaCAS_v12\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_SistemaCAS_v12_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_SistemaCAS_v12InstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"sinal_atenuado");
          _SFD_SET_DATA_PROPS(1,1,1,0,"frequencia");
          _SFD_SET_DATA_PROPS(2,2,0,1,"ruido_total");
          _SFD_SET_DATA_PROPS(3,1,1,0,"n");
          _SFD_SET_DATA_PROPS(4,1,1,0,"v");
          _SFD_SET_DATA_PROPS(5,2,0,1,"sinal_ruidoso");
...

        {
          ...
          c6_frequencia = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c6_sinal_atenuado = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c6_sinal_atenuado);
          _SFD_SET_DATA_VALUE_PTR(1U, c6_frequencia);
          _SFD_SET_DATA_VALUE_PTR(2U, c6_ruido_total);
          _SFD_SET_DATA_VALUE_PTR(3U, c6_n);
          _SFD_SET_DATA_VALUE_PTR(4U, c6_v);
          _SFD_SET_DATA_VALUE_PTR(5U, c6_sinal_ruidoso);
        }
      }
    } else {
...
{
  return "uVlKCKcTfRdVRtGHUqhHeG";
}

static void sf_opaque_initialize_c6_SistemaCAS_v12(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
  initialize_c6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_SistemaCAS_v12(void *chartInstanceVar)
{
  enable_c6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_SistemaCAS_v12(void *chartInstanceVar)
{
  disable_c6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_SistemaCAS_v12(void *chartInstanceVar)
{
  sf_gateway_c6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_SistemaCAS_v12(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_SistemaCAS_v12
    ((SFc6_SistemaCAS_v12InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_SistemaCAS_v12();/* state var info */
...
extern void sf_internal_set_sim_state_c6_SistemaCAS_v12(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_SistemaCAS_v12();/* state var info */
  ...
  set_sim_state_c6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_SistemaCAS_v12(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_SistemaCAS_v12(S);
}

static void sf_opaque_set_sim_state_c6_SistemaCAS_v12(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_SistemaCAS_v12(S, st);
}

static void sf_opaque_terminate_c6_SistemaCAS_v12(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_SistemaCAS_v12InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_SistemaCAS_v12((SFc6_SistemaCAS_v12InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_SistemaCAS_v12(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_SistemaCAS_v12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4237837775U));
  ssSetChecksum1(S,(4174580803U));
  ssSetChecksum2(S,(2196193243U));
  ssSetChecksum3(S,(1901959030U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_SistemaCAS_v12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_SistemaCAS_v12(SimStruct *S)
{
  SFc6_SistemaCAS_v12InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_SistemaCAS_v12InstanceStruct *)utMalloc(sizeof
    (SFc6_SistemaCAS_v12InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_SistemaCAS_v12InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_SistemaCAS_v12;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_SistemaCAS_v12;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_SistemaCAS_v12;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_SistemaCAS_v12;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_SistemaCAS_v12;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_SistemaCAS_v12;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_SistemaCAS_v12;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_SistemaCAS_v12;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_SistemaCAS_v12;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_SistemaCAS_v12;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_SistemaCAS_v12;
...
void c6_SistemaCAS_v12_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_SistemaCAS_v12(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_SistemaCAS_v12(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_SistemaCAS_v12(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_SistemaCAS_v12_method_dispatcher.\n"
