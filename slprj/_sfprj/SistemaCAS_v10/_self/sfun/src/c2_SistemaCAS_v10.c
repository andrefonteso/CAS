...
#include <stddef.h>
#include "blas.h"
#include "SistemaCAS_v10_sfun.h"
#include "c2_SistemaCAS_v10.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "SistemaCAS_v10_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[20] = { "w", "l", "d", "T", "S", "pH",
  "D", "C", "i", "c", "nargin", "nargout", "parametros_aquario",
  "parametros_ambientais", "caminhos", "atraso1", "atraso2", "atraso3",
  "atraso4", "atraso5" };

/* Function Declarations */
static void initialize_c2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
static void initialize_params_c2_SistemaCAS_v10
  (SFc2_SistemaCAS_v10InstanceStruct *chartInstance);
static void enable_c2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
static void disable_c2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_SistemaCAS_v10
  (SFc2_SistemaCAS_v10InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SistemaCAS_v10
  (SFc2_SistemaCAS_v10InstanceStruct *chartInstance);
static void set_sim_state_c2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
static void sf_gateway_c2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
static void c2_chartstep_c2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
static void initSimStructsc2_SistemaCAS_v10(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_atraso5, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_caminhos, const char_T *c2_identifier,
  real_T c2_y[5]);
static void c2_d_emlrt_marshallIn(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[5]);
...
static real_T c2_mpower(SFc2_SistemaCAS_v10InstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_SistemaCAS_v10InstanceStruct *chartInstance);
static void c2_eml_error(SFc2_SistemaCAS_v10InstanceStruct *chartInstance);
static real_T c2_mean(SFc2_SistemaCAS_v10InstanceStruct *chartInstance, real_T
                      c2_x[2]);
static real_T c2_b_mpower(SFc2_SistemaCAS_v10InstanceStruct *chartInstance,
  real_T c2_a);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_SistemaCAS_v10, const char_T *
  c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_SistemaCAS_v10InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SistemaCAS_v10 = 0U;
}
  ...
  (SFc2_SistemaCAS_v10InstanceStruct *chartInstance)
{
  ...
  c2_atraso5 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 6);
  c2_atraso4 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  c2_atraso3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c2_atraso2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c2_atraso1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c2_caminhos = (real_T (*)[5])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  ...
  c2_f_hoistedGlobal = chartInstance->c2_is_active_c2_SistemaCAS_v10;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_atraso1 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 0)), "atraso1");
  *c2_atraso2 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 1)), "atraso2");
  *c2_atraso3 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 2)), "atraso3");
  *c2_atraso4 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 3)), "atraso4");
  *c2_atraso5 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 4)), "atraso5");
  ...
  chartInstance->c2_is_active_c2_SistemaCAS_v10 = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 6)),
     "is_active_c2_SistemaCAS_v10");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SistemaCAS_v10(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_SistemaCAS_v10(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v10MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c2_i2 = 0; c2_i2 < 5; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*c2_caminhos)[c2_i2], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_atraso1, 1U);
  _SFD_DATA_RANGE_CHECK(*c2_atraso2, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_atraso3, 3U);
  _SFD_DATA_RANGE_CHECK(*c2_atraso4, 4U);
  _SFD_DATA_RANGE_CHECK(*c2_atraso5, 5U);
  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*c2_parametros_aquario)[c2_i3], 6U);
  }

  for (c2_i4 = 0; c2_i4 < 3; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*c2_parametros_ambientais)[c2_i4], 7U);
  }
}
  ...
  *chartInstance)
{
  ...
  c2_b_parametros_aquario = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S,
    0);
  c2_b_atraso5 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 6);
  c2_b_atraso4 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  c2_b_atraso3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c2_b_atraso2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c2_b_atraso1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c2_b_caminhos = (real_T (*)[5])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_w, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_l, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_d, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_T, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_S, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_pH, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_D, 6U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_C, 7U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_i, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_parametros_aquario, 12U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_parametros_ambientais, 13U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_caminhos, 14U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso1, 15U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso2, 16U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso3, 17U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso4, 18U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso5, 19U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_x = c2_mpower(chartInstance, c2_d) + c2_mpower(chartInstance, c2_l);
  c2_b_x = c2_x;
  if (c2_b_x < 0.0) {
  ...
  c2_caminhos[0] = c2_b_x;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 26);
  c2_c_x = c2_mpower(chartInstance, c2_w) + c2_mpower(chartInstance, c2_l);
  c2_d_x = c2_c_x;
  if (c2_d_x < 0.0) {
    c2_eml_error(chartInstance);
  }
  ...
  c2_b_y[0] = c2_y;
  c2_b_y[1] = 0.0;
  c2_D[0] = c2_mean(chartInstance, c2_b_y);
  ...
  c2_b_d[0] = c2_d;
  c2_b_d[1] = c2_f_y;
  c2_D[4] = c2_mean(chartInstance, c2_b_d);
  ...
  while (c2_b_i < 5) {
    ...
    c2_c = (((((((1448.96 + 4.591 * c2_T) - 0.053040000000000004 * c2_mpower
                 (chartInstance, c2_T)) + 0.00023740000000000002 * c2_b_mpower
                (chartInstance, c2_T)) + 1.34 * (c2_S - 35.0)) + 0.0163 *
              c2_D[_SFD_EML_ARRAY_BOUNDS_CHECK("D", (int32_T)_SFD_INTEGER_CHECK(
                "i", c2_i), 1, 5, 1, 0) - 1]) + 1.6749999999999998E-7 *
             c2_mpower(chartInstance, c2_D[_SFD_EML_ARRAY_BOUNDS_CHECK("D",
               (int32_T)_SFD_INTEGER_CHECK("i", c2_i), 1, 5, 1, 0) - 1])) -
            0.010249999999999999 * c2_T * (c2_S - 35.0)) - 7.139E-13 * c2_T
      * c2_b_mpower(chartInstance, c2_D[_SFD_EML_ARRAY_BOUNDS_CHECK("D",
      (int32_T)_SFD_INTEGER_CHECK("i", c2_i), 1, 5, 1, 0) - 1]);
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 52);
    c2_C[_SFD_EML_ARRAY_BOUNDS_CHECK("C", (int32_T)_SFD_INTEGER_CHECK("i", c2_i),
      1, 5, 1, 0) - 1] = c2_c * 100.0;
    c2_b_i++;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SistemaCAS_v10InstanceStruct *chartInstance;
  chartInstance = (SFc2_SistemaCAS_v10InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c2_atraso5, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_atraso5), &c2_thisId);
  ...
  real_T c2_y[5])
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_caminhos), &c2_thisId, c2_y);
...
const mxArray *sf_c2_SistemaCAS_v10_get_eml_resolved_functions_info(void)
{
  ...
  c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SistemaCAS_v10), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SistemaCAS_v10);
  return c2_y;
}
...
void sf_c2_SistemaCAS_v10_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1282173583U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3309822656U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3395532223U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(497681763U);
}

mxArray *sf_c2_SistemaCAS_v10_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("4d3De10GUdbwURwik1ZGbC");
...
mxArray *sf_c2_SistemaCAS_v10_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_SistemaCAS_v10_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_SistemaCAS_v10(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[10],T\"atraso1\",},{M[1],M[11],T\"atraso2\",},{M[1],M[12],T\"atraso3\",},{M[1],M[13],T\"atraso4\",},{M[1],M[14],T\"atraso5\",},{M[1],M[5],T\"caminhos\",},{M[8],M[0],T\"is_active_c2_SistemaCAS_v10\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SistemaCAS_v10_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_SistemaCAS_v10InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_SistemaCAS_v10MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_SistemaCAS_v10MachineNumber_,
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"caminhos");
          _SFD_SET_DATA_PROPS(1,2,0,1,"atraso1");
          _SFD_SET_DATA_PROPS(2,2,0,1,"atraso2");
          _SFD_SET_DATA_PROPS(3,2,0,1,"atraso3");
          _SFD_SET_DATA_PROPS(4,2,0,1,"atraso4");
          _SFD_SET_DATA_PROPS(5,2,0,1,"atraso5");
          _SFD_SET_DATA_PROPS(6,1,1,0,"parametros_aquario");
          _SFD_SET_DATA_PROPS(7,1,1,0,"parametros_ambientais");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2318);
        _SFD_CV_INIT_EML_FOR(0,1,0,1529,1541,1851);
...

        {
          ...
          c2_atraso1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c2_caminhos = (real_T (*)[5])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c2_caminhos);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_atraso1);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_atraso2);
          _SFD_SET_DATA_VALUE_PTR(3U, c2_atraso3);
          _SFD_SET_DATA_VALUE_PTR(4U, c2_atraso4);
          _SFD_SET_DATA_VALUE_PTR(5U, c2_atraso5);
          _SFD_SET_DATA_VALUE_PTR(6U, *c2_parametros_aquario);
          _SFD_SET_DATA_VALUE_PTR(7U, *c2_parametros_ambientais);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _SistemaCAS_v10MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "FPhGR0naTRDmWXTnVQ5ajG";
}

static void sf_opaque_initialize_c2_SistemaCAS_v10(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_SistemaCAS_v10InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*)
    chartInstanceVar);
  initialize_c2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_SistemaCAS_v10(void *chartInstanceVar)
{
  enable_c2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_SistemaCAS_v10(void *chartInstanceVar)
{
  disable_c2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_SistemaCAS_v10(void *chartInstanceVar)
{
  sf_gateway_c2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_SistemaCAS_v10(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SistemaCAS_v10
    ((SFc2_SistemaCAS_v10InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_SistemaCAS_v10();/* state var info */
...
extern void sf_internal_set_sim_state_c2_SistemaCAS_v10(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_SistemaCAS_v10();/* state var info */
  ...
  set_sim_state_c2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_SistemaCAS_v10(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SistemaCAS_v10(S);
}

static void sf_opaque_set_sim_state_c2_SistemaCAS_v10(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_SistemaCAS_v10(S, st);
}

static void sf_opaque_terminate_c2_SistemaCAS_v10(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SistemaCAS_v10InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SistemaCAS_v10_optimization_info();
    }

    finalize_c2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_SistemaCAS_v10((SFc2_SistemaCAS_v10InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SistemaCAS_v10(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_SistemaCAS_v10(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_SistemaCAS_v10_optimization_info();
  ...
  ssSetChecksum0(S,(388928102U));
  ssSetChecksum1(S,(3884149035U));
  ssSetChecksum2(S,(3961314344U));
  ssSetChecksum3(S,(2493714296U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_SistemaCAS_v10(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_SistemaCAS_v10(SimStruct *S)
{
  SFc2_SistemaCAS_v10InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_SistemaCAS_v10InstanceStruct *)utMalloc(sizeof
    (SFc2_SistemaCAS_v10InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_SistemaCAS_v10InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_SistemaCAS_v10;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SistemaCAS_v10;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_SistemaCAS_v10;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_SistemaCAS_v10;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_SistemaCAS_v10;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SistemaCAS_v10;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SistemaCAS_v10;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SistemaCAS_v10;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SistemaCAS_v10;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SistemaCAS_v10;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_SistemaCAS_v10;
...
void c2_SistemaCAS_v10_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SistemaCAS_v10(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SistemaCAS_v10(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SistemaCAS_v10(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SistemaCAS_v10_method_dispatcher.\n"
