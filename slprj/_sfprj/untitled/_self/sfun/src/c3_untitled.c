...
static real_T c3_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_sinal_atenuado, const char_T *c3_identifier);
...
static real_T c3_mpower(SFc3_untitledInstanceStruct *chartInstance, real_T c3_a);
...
static const mxArray *sf_get_sim_state_info_c3_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[8],T\"sinal_atenuado\",},{M[8],M[0],T\"is_active_c3_untitled\",}}"
  };
