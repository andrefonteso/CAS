...
static real_T c2_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_atraso5, const char_T *c2_identifier);
...
static real_T c2_mean(SFc2_untitledInstanceStruct *chartInstance, real_T c2_x[2]);
  ...
  *chartInstance)
{
  ...
  c2_f_hoistedGlobal = chartInstance->c2_is_active_c2_untitled;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_atraso5 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_untitled = c2_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 6)), "is_active_c2_untitled");
  sf_mex_destroy(&c2_u);
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[10],T\"atraso1\",},{M[1],M[11],T\"atraso2\",},{M[1],M[12],T\"atraso3\",},{M[1],M[13],T\"atraso4\",},{M[1],M[14],T\"atraso5\",},{M[1],M[5],T\"caminhos\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
