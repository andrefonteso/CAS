...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[15],T\"parametros_ambientais\",},{M[1],M[11],T\"parametros_aquario\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
  ...
  *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_untitled();/* state var info */
