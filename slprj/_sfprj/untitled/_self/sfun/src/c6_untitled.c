...
static void c6_chartstep_c6_untitled(SFc6_untitledInstanceStruct *chartInstance);
...
static real_T c6_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_ruido_total, const char_T *c6_identifier);
...
static real_T c6_log10(SFc6_untitledInstanceStruct *chartInstance, real_T c6_x);
static void c6_eml_error(SFc6_untitledInstanceStruct *chartInstance);
static real_T c6_mpower(SFc6_untitledInstanceStruct *chartInstance, real_T c6_a,
  real_T c6_b);
static void c6_eml_scalar_eg(SFc6_untitledInstanceStruct *chartInstance);
static void c6_b_eml_error(SFc6_untitledInstanceStruct *chartInstance);
static void c6_c_eml_error(SFc6_untitledInstanceStruct *chartInstance);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
...
static uint8_T c6_e_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_log10(SFc6_untitledInstanceStruct *chartInstance, real_T *c6_x);
  ...
  *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_untitled;
  ...
  const mxArray *c6_st)
{
  ...
  *c6_ruido_total = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 0)), "ruido_total");
  chartInstance->c6_is_active_c6_untitled = c6_d_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c6_untitled(SFc6_untitledInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_untitled(chartInstance);
...
static const mxArray *sf_get_sim_state_info_c6_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ruido_total\",},{M[8],M[0],T\"is_active_c6_untitled\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_untitledInstanceStruct *) chartInfo->chartInstance;
  ...
  *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_untitled();/* state var info */
