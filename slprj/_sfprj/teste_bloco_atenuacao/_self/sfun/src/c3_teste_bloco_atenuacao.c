...
static const char * c3_debug_family_names[16] = { "T", "S", "pH", "D", "caminho",
  "frequencia", "f1", "f2", "a", "atenuacao", "nargin", "nargout",
  "sinal_espalhado", "sinal_atenuado", "ganho", "difer" };

/* Function Declarations */
static void initialize_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void initialize_params_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void enable_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void disable_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void set_sim_state_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void sf_gateway_c3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void initSimStructsc3_teste_bloco_atenuacao
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_teste_bloco_atenuacaoInstanceStruct
  *chartInstance, const mxArray *c3_difer, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_teste_bloco_atenuacaoInstanceStruct
...
static void c3_eml_scalar_eg(SFc3_teste_bloco_atenuacaoInstanceStruct
  *chartInstance);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_teste_bloco_atenuacaoInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_teste_bloco_atenuacaoInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_teste_bloco_atenuacao, const
  char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_teste_bloco_atenuacaoInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_teste_bloco_atenuacaoInstanceStruct
  *chartInstance);
  ...
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_teste_bloco_atenuacao = 0U;
}
  ...
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance)
{
  ...
  c3_difer = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c3_ganho = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_sinal_atenuado = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellmatrix(4, 1), false);
  c3_hoistedGlobal = *c3_difer;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = *c3_ganho;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = *c3_sinal_atenuado;
  c3_c_u = c3_c_hoistedGlobal;
  c3_d_y = NULL;
  sf_mex_assign(&c3_d_y, sf_mex_create("y", &c3_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 2, c3_d_y);
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_teste_bloco_atenuacao;
  ...
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_difer = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "difer");
  *c3_ganho = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    1)), "ganho");
  *c3_sinal_atenuado = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 2)), "sinal_atenuado");
  chartInstance->c3_is_active_c3_teste_bloco_atenuacao = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 3)),
     "is_active_c3_teste_bloco_atenuacao");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_teste_bloco_atenuacao(chartInstance);
  ...
  (SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance)
{
  ...
  real_T *c3_b_sinal_espalhado;
  c3_b_difer = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c3_b_ganho = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_b_sinal_atenuado = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_b_sinal_espalhado = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c3_b_sinal_espalhado, 0U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_b_sinal_espalhado;
  c3_sinal_espalhado = c3_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 16U, 16U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_T, 0U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_S, 1U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_pH, 2U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_D, 3U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_caminho, 4U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_frequencia, 5U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_f1, 6U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_f2, 7U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_a, 8U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_atenuacao, 9U, c3_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 11U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado, 12U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado, 13U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_ganho, 14U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_difer, 15U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_eml_scalar_eg(chartInstance);
  c3_sinal_atenuado = c3_sinal_espalhado * 7.6058410612872042E-11;
  sf_mex_printf("%s =\\n", "sinal_atenuado");
  c3_b_u = c3_sinal_atenuado;
  c3_b_y = NULL;
  ...
  c3_difer = c3_sinal_atenuado - (-c3_atenuacao);
  sf_mex_printf("%s =\\n", "difer");
  c3_c_u = c3_difer;
  c3_c_y = NULL;
  ...
  c3_ganho = c3_sinal_atenuado - c3_sinal_espalhado;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -50);
  ...
  *c3_b_difer = c3_difer;
  ...
  _SFD_DATA_RANGE_CHECK(*c3_b_sinal_atenuado, 1U);
  _SFD_DATA_RANGE_CHECK(*c3_b_ganho, 2U);
  _SFD_DATA_RANGE_CHECK(*c3_b_difer, 3U);
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance;
  chartInstance = (SFc3_teste_bloco_atenuacaoInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c3_difer, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_difer), &c3_thisId);
  sf_mex_destroy(&c3_difer);
  return c3_y;
}
...
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_difer;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  real_T c3_y;
  SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance;
  chartInstance = (SFc3_teste_bloco_atenuacaoInstanceStruct *)chartInstanceVoid;
  c3_difer = sf_mex_dup(c3_mxArrayInData);
...
const mxArray *sf_c3_teste_bloco_atenuacao_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_teste_bloco_atenuacao), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_teste_bloco_atenuacao);
  return c3_y;
}
...
void sf_c3_teste_bloco_atenuacao_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1490256153U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2231853159U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(953008657U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(905327222U);
}

mxArray *sf_c3_teste_bloco_atenuacao_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kZRDblhnbbeFvshzsBcSfH");
...
mxArray *sf_c3_teste_bloco_atenuacao_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_teste_bloco_atenuacao_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_teste_bloco_atenuacao(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[32],T\"difer\",},{M[1],M[30],T\"ganho\",},{M[1],M[20],T\"sinal_atenuado\",},{M[8],M[0],T\"is_active_c3_teste_bloco_atenuacao\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_teste_bloco_atenuacao_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_teste_bloco_atenuacaoInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"sinal_espalhado");
          _SFD_SET_DATA_PROPS(1,2,0,1,"sinal_atenuado");
          _SFD_SET_DATA_PROPS(2,2,0,1,"ganho");
          _SFD_SET_DATA_PROPS(3,2,0,1,"difer");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2474);
...

        {
          ...
          c3_sinal_atenuado = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            1);
          c3_sinal_espalhado = (real_T *)ssGetInputPortSignal(chartInstance->S,
            0);
          _SFD_SET_DATA_VALUE_PTR(0U, c3_sinal_espalhado);
          _SFD_SET_DATA_VALUE_PTR(1U, c3_sinal_atenuado);
          _SFD_SET_DATA_VALUE_PTR(2U, c3_ganho);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_difer);
        }
      }
    } else {
...
{
  return "A52oP1apb3pFEcPtlX4hCB";
}

static void sf_opaque_initialize_c3_teste_bloco_atenuacao(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_teste_bloco_atenuacaoInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_teste_bloco_atenuacao
    ((SFc3_teste_bloco_atenuacaoInstanceStruct*) chartInstanceVar);
  initialize_c3_teste_bloco_atenuacao((SFc3_teste_bloco_atenuacaoInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_teste_bloco_atenuacao(void *chartInstanceVar)
{
  enable_c3_teste_bloco_atenuacao((SFc3_teste_bloco_atenuacaoInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_teste_bloco_atenuacao(void *chartInstanceVar)
{
  disable_c3_teste_bloco_atenuacao((SFc3_teste_bloco_atenuacaoInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_teste_bloco_atenuacao(void *chartInstanceVar)
{
  sf_gateway_c3_teste_bloco_atenuacao((SFc3_teste_bloco_atenuacaoInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_teste_bloco_atenuacao
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_teste_bloco_atenuacao
    ((SFc3_teste_bloco_atenuacaoInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_teste_bloco_atenuacao();/* state var info */
...
extern void sf_internal_set_sim_state_c3_teste_bloco_atenuacao(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_teste_bloco_atenuacao();/* state var info */
  ...
  set_sim_state_c3_teste_bloco_atenuacao
    ((SFc3_teste_bloco_atenuacaoInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_teste_bloco_atenuacao(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c3_teste_bloco_atenuacao(S);
}

static void sf_opaque_set_sim_state_c3_teste_bloco_atenuacao(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_teste_bloco_atenuacao(S, st);
}

static void sf_opaque_terminate_c3_teste_bloco_atenuacao(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_teste_bloco_atenuacaoInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_teste_bloco_atenuacao((SFc3_teste_bloco_atenuacaoInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_teste_bloco_atenuacao
    ((SFc3_teste_bloco_atenuacaoInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_teste_bloco_atenuacao(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_teste_bloco_atenuacao(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1971825743U));
  ssSetChecksum1(S,(936309295U));
  ssSetChecksum2(S,(1108759379U));
  ssSetChecksum3(S,(2788003052U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_teste_bloco_atenuacao(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_teste_bloco_atenuacao(SimStruct *S)
{
  SFc3_teste_bloco_atenuacaoInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_teste_bloco_atenuacaoInstanceStruct *)utMalloc(sizeof
    (SFc3_teste_bloco_atenuacaoInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_teste_bloco_atenuacaoInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_teste_bloco_atenuacao;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_teste_bloco_atenuacao;
...
void c3_teste_bloco_atenuacao_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_teste_bloco_atenuacao(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_teste_bloco_atenuacao(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_teste_bloco_atenuacao(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_teste_bloco_atenuacao_method_dispatcher.\n"
