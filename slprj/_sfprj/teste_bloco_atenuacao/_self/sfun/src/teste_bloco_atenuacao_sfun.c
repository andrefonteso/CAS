...
uint32_T _teste_bloco_atenuacaoMachineNumber_;

/* Function Declarations */

/* Function Definitions */
void teste_bloco_atenuacao_initializer(void)
{
}

void teste_bloco_atenuacao_terminator(void)
{
}
  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==4) {
    c4_teste_bloco_atenuacao_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
...
unsigned int sf_teste_bloco_atenuacao_process_check_sum_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3859919709U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2134833996U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3373097991U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2113736013U);
       ...
       case 3:
        {
          ...
          sf_c3_teste_bloco_atenuacao_get_check_sum(plhs);
          break;
        }

       case 4:
        {
          extern void sf_c4_teste_bloco_atenuacao_get_check_sum(mxArray *plhs[]);
          sf_c4_teste_bloco_atenuacao_get_check_sum(plhs);
          break;
        }
...
unsigned int sf_teste_bloco_atenuacao_autoinheritance_info( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
...
unsigned int sf_teste_bloco_atenuacao_get_eml_resolved_functions_info( int nlhs,
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        extern const mxArray
          *sf_c3_teste_bloco_atenuacao_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c3_teste_bloco_atenuacao_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
     ...
     case 4:
      {
        extern const mxArray
          *sf_c4_teste_bloco_atenuacao_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c4_teste_bloco_atenuacao_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
...
unsigned int sf_teste_bloco_atenuacao_third_party_uses_info( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int sf_teste_bloco_atenuacao_updateBuildInfo_args_info( int nlhs,
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
void teste_bloco_atenuacao_debug_initialize(struct SfDebugInstanceStruct*
  debugInstance)
{
  ...
  sf_debug_set_machine_data_thresholds(debugInstance,
    _teste_bloco_atenuacaoMachineNumber_,0);
}

void teste_bloco_atenuacao_register_exported_symbols(SimStruct* S)
{
}

static mxArray* sRtwOptimizationInfoStruct= NULL;
mxArray* load_teste_bloco_atenuacao_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "teste_bloco_atenuacao", "teste_bloco_atenuacao");
...
void unload_teste_bloco_atenuacao_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct!=NULL) {
