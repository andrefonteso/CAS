...
static void initialize_c9_SistemaCAS_v19(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void initialize_params_c9_SistemaCAS_v19
  (SFc9_SistemaCAS_v19InstanceStruct *chartInstance);
static void enable_c9_SistemaCAS_v19(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void disable_c9_SistemaCAS_v19(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void c9_update_debugger_state_c9_SistemaCAS_v19
  (SFc9_SistemaCAS_v19InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_SistemaCAS_v19
  (SFc9_SistemaCAS_v19InstanceStruct *chartInstance);
static void set_sim_state_c9_SistemaCAS_v19(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c9_st);
static void finalize_c9_SistemaCAS_v19(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void sf_gateway_c9_SistemaCAS_v19(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void initSimStructsc9_SistemaCAS_v19(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c9_perda_transmissao5, const char_T
  *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_SistemaCAS_v19InstanceStruct
...
static real_T c9_log10(SFc9_SistemaCAS_v19InstanceStruct *chartInstance, real_T
  c9_x);
static void c9_eml_error(SFc9_SistemaCAS_v19InstanceStruct *chartInstance);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_d_emlrt_marshallIn(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_SistemaCAS_v19, const char_T *
  c9_identifier);
static uint8_T c9_e_emlrt_marshallIn(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_log10(SFc9_SistemaCAS_v19InstanceStruct *chartInstance, real_T *
  c9_x);
static void init_dsm_address_info(SFc9_SistemaCAS_v19InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_SistemaCAS_v19 = 0U;
}
  ...
  (SFc9_SistemaCAS_v19InstanceStruct *chartInstance)
{
  ...
  c9_f_hoistedGlobal = chartInstance->c9_is_active_c9_SistemaCAS_v19;
  ...
  *chartInstance, const mxArray *c9_st)
{
  ...
  *c9_perda_transmissao5 = c9_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c9_is_active_c9_SistemaCAS_v19 = c9_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 5)),
     "is_active_c9_SistemaCAS_v19");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_SistemaCAS_v19(chartInstance);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_SistemaCAS_v19InstanceStruct *chartInstance;
  chartInstance = (SFc9_SistemaCAS_v19InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_SistemaCAS_v19_get_eml_resolved_functions_info(void)
{
  ...
  c9_identifier)
{
  ...
  c9_y = c9_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_SistemaCAS_v19), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_SistemaCAS_v19);
  return c9_y;
}
...
void sf_c9_SistemaCAS_v19_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_SistemaCAS_v19_get_autoinheritance_info(void)
{
...
mxArray *sf_c9_SistemaCAS_v19_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_SistemaCAS_v19_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c9_SistemaCAS_v19(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"perda_transmissao1\",},{M[1],M[9],T\"perda_transmissao2\",},{M[1],M[10],T\"perda_transmissao3\",},{M[1],M[11],T\"perda_transmissao4\",},{M[1],M[12],T\"perda_transmissao5\",},{M[8],M[0],T\"is_active_c9_SistemaCAS_v19\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_SistemaCAS_v19_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_SistemaCAS_v19InstanceStruct *)
...
static void sf_opaque_initialize_c9_SistemaCAS_v19(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
  initialize_c9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_SistemaCAS_v19(void *chartInstanceVar)
{
  enable_c9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_SistemaCAS_v19(void *chartInstanceVar)
{
  disable_c9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_SistemaCAS_v19(void *chartInstanceVar)
{
  sf_gateway_c9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_SistemaCAS_v19(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_SistemaCAS_v19
    ((SFc9_SistemaCAS_v19InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v19();/* state var info */
...
extern void sf_internal_set_sim_state_c9_SistemaCAS_v19(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v19();/* state var info */
  ...
  set_sim_state_c9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_SistemaCAS_v19(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_SistemaCAS_v19(S);
}

static void sf_opaque_set_sim_state_c9_SistemaCAS_v19(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_SistemaCAS_v19(S, st);
}

static void sf_opaque_terminate_c9_SistemaCAS_v19(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_SistemaCAS_v19InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_SistemaCAS_v19((SFc9_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_SistemaCAS_v19(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_SistemaCAS_v19(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c9_SistemaCAS_v19(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_SistemaCAS_v19(SimStruct *S)
{
  SFc9_SistemaCAS_v19InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_SistemaCAS_v19InstanceStruct *)utMalloc(sizeof
    (SFc9_SistemaCAS_v19InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_SistemaCAS_v19InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_SistemaCAS_v19;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_SistemaCAS_v19;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_SistemaCAS_v19;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_SistemaCAS_v19;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_SistemaCAS_v19;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_SistemaCAS_v19;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_SistemaCAS_v19;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_SistemaCAS_v19;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_SistemaCAS_v19;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_SistemaCAS_v19;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_SistemaCAS_v19;
...
void c9_SistemaCAS_v19_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_SistemaCAS_v19(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_SistemaCAS_v19(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_SistemaCAS_v19(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_SistemaCAS_v19_method_dispatcher.\n"
