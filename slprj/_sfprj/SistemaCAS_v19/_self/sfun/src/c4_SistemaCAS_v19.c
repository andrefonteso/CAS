...
#include <stddef.h>
#include "blas.h"
#include "SistemaCAS_v19_sfun.h"
#include "c4_SistemaCAS_v19.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "SistemaCAS_v19_sfun_debug_macros.h"
...
static const char * c4_debug_family_names[19] = { "perda_espalhamento1",
  "perda_espalhamento2", "perda_espalhamento3", "perda_espalhamento4",
  "perda_espalhamento5", "nargin", "nargout", "k", "sinal_atrasado1",
  "sinal_atrasado2", "sinal_atrasado3", "sinal_atrasado4", "sinal_atrasado5",
  "caminhos", "sinal_espalhado1", "sinal_espalhado2", "sinal_espalhado3",
  "sinal_espalhado4", "sinal_espalhado5" };

/* Function Declarations */
static void initialize_c4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void initialize_params_c4_SistemaCAS_v19
  (SFc4_SistemaCAS_v19InstanceStruct *chartInstance);
static void enable_c4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void disable_c4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_SistemaCAS_v19
  (SFc4_SistemaCAS_v19InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_SistemaCAS_v19
  (SFc4_SistemaCAS_v19InstanceStruct *chartInstance);
static void set_sim_state_c4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void sf_gateway_c4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void c4_chartstep_c4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void initSimStructsc4_SistemaCAS_v19(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c4_sinal_espalhado5, const char_T
  *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_SistemaCAS_v19InstanceStruct
...
static real_T c4_log10(SFc4_SistemaCAS_v19InstanceStruct *chartInstance, real_T
  c4_x);
static void c4_eml_error(SFc4_SistemaCAS_v19InstanceStruct *chartInstance);
static real_T c4_mpower(SFc4_SistemaCAS_v19InstanceStruct *chartInstance, real_T
  c4_a, real_T c4_b);
static void c4_eml_scalar_eg(SFc4_SistemaCAS_v19InstanceStruct *chartInstance);
static void c4_b_eml_error(SFc4_SistemaCAS_v19InstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_SistemaCAS_v19, const char_T *
  c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_log10(SFc4_SistemaCAS_v19InstanceStruct *chartInstance, real_T *
  c4_x);
static void init_dsm_address_info(SFc4_SistemaCAS_v19InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_SistemaCAS_v19 = 0U;
}
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_sinal_espalhado1 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 0)), "sinal_espalhado1");
  *c4_sinal_espalhado2 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 1)), "sinal_espalhado2");
  *c4_sinal_espalhado3 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 2)), "sinal_espalhado3");
  *c4_sinal_espalhado4 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 3)), "sinal_espalhado4");
  *c4_sinal_espalhado5 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 4)), "sinal_espalhado5");
  chartInstance->c4_is_active_c4_SistemaCAS_v19 = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 5)),
     "is_active_c4_SistemaCAS_v19");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_SistemaCAS_v19(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_SistemaCAS_v19(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v19MachineNumber_,
  ...
  *chartInstance)
{
  ...
  real_T c4_perda_espalhamento1;
  real_T c4_perda_espalhamento2;
  real_T c4_perda_espalhamento3;
  real_T c4_perda_espalhamento4;
  real_T c4_perda_espalhamento5;
  ...
  real_T *c4_b_sinal_espalhado2;
  real_T *c4_b_sinal_espalhado1;
  real_T *c4_b_sinal_atrasado5;
  real_T *c4_b_sinal_atrasado4;
  real_T *c4_b_sinal_atrasado3;
  real_T *c4_b_sinal_atrasado2;
  real_T *c4_b_sinal_atrasado1;
  real_T *c4_b_k;
  real_T (*c4_b_caminhos)[5];
  c4_b_caminhos = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 6);
  c4_b_sinal_espalhado5 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  c4_b_sinal_espalhado4 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c4_b_sinal_espalhado3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c4_b_sinal_espalhado2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c4_b_sinal_espalhado1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_sinal_atrasado5 = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c4_b_sinal_atrasado4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c4_b_sinal_atrasado3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  c4_c_hoistedGlobal = *c4_b_sinal_atrasado2;
  c4_d_hoistedGlobal = *c4_b_sinal_atrasado3;
  c4_e_hoistedGlobal = *c4_b_sinal_atrasado4;
  c4_f_hoistedGlobal = *c4_b_sinal_atrasado5;
  c4_k = c4_hoistedGlobal;
  c4_sinal_atrasado1 = c4_b_hoistedGlobal;
  c4_sinal_atrasado2 = c4_c_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_perda_espalhamento1, 0U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_perda_espalhamento2, 1U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_perda_espalhamento3, 2U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_perda_espalhamento4, 3U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_perda_espalhamento5, 4U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_k, 7U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_sinal_atrasado1, 8U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_sinal_atrasado2, 9U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_sinal_atrasado3, 10U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_sinal_atrasado4, 11U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_sinal_atrasado5, 12U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_caminhos, 13U, c4_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_sinal_espalhado1, 14U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_sinal_espalhado2, 15U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_sinal_espalhado3, 16U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_sinal_espalhado4, 17U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_sinal_espalhado5, 18U,
    c4_sf_marshallOut, c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 12);
  c4_d0 = c4_caminhos[0] * 1000.0;
  c4_b_log10(chartInstance, &c4_d0);
  c4_perda_espalhamento1 = c4_k * 10.0 * c4_d0;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 13);
  c4_d1 = c4_caminhos[1] * 1000.0;
  c4_b_log10(chartInstance, &c4_d1);
  c4_perda_espalhamento2 = c4_k * 10.0 * c4_d1;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 14);
  c4_d2 = c4_caminhos[2] * 1000.0;
  c4_b_log10(chartInstance, &c4_d2);
  c4_perda_espalhamento3 = c4_k * 10.0 * c4_d2;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 15);
  c4_d3 = c4_caminhos[3] * 1000.0;
  c4_b_log10(chartInstance, &c4_d3);
  c4_perda_espalhamento4 = c4_k * 10.0 * c4_d3;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 16);
  c4_d4 = c4_caminhos[4] * 1000.0;
  c4_b_log10(chartInstance, &c4_d4);
  c4_perda_espalhamento5 = c4_k * 10.0 * c4_d4;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 24);
  c4_A = -c4_perda_espalhamento1;
  c4_x = c4_A;
  c4_b_x = c4_x;
  c4_c_x = c4_b_x;
  c4_y = c4_c_x / 10.0;
  ...
  *c4_b_sinal_espalhado3 = c4_sinal_espalhado3;
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_SistemaCAS_v19InstanceStruct *chartInstance;
  chartInstance = (SFc4_SistemaCAS_v19InstanceStruct *)chartInstanceVoid;
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_sinal_espalhado5),
    &c4_thisId);
  sf_mex_destroy(&c4_sinal_espalhado5);
  return c4_y;
}
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_sinal_espalhado5;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_SistemaCAS_v19InstanceStruct *chartInstance;
  chartInstance = (SFc4_SistemaCAS_v19InstanceStruct *)chartInstanceVoid;
  c4_sinal_espalhado5 = sf_mex_dup(c4_mxArrayInData);
  ...
  *c4_inData)
{
  ...
  for (c4_i2 = 0; c4_i2 < 5; c4_i2++) {
    c4_b_inData[c4_i2] = (*(real_T (*)[5])c4_inData)[c4_i2];
  }
...
const mxArray *sf_c4_SistemaCAS_v19_get_eml_resolved_functions_info(void)
{
  ...
  c4_x)
{
  real_T c4_b_x;
  c4_b_x = c4_x;
  c4_b_log10(chartInstance, &c4_b_x);
  return c4_b_x;
}
...
static void c4_eml_error(SFc4_SistemaCAS_v19InstanceStruct *chartInstance)
{
  ...
  const mxArray *c4_y = NULL;
  int32_T c4_i5;
  static char_T c4_cv1[5] = { 'l', 'o', 'g', '1', '0' };

  char_T c4_b_u[5];
  const mxArray *c4_b_y = NULL;
  (void)chartInstance;
  for (c4_i4 = 0; c4_i4 < 30; c4_i4++) {
...
static void c4_b_eml_error(SFc4_SistemaCAS_v19InstanceStruct *chartInstance)
{
  ...
  const mxArray *c4_y = NULL;
  (void)chartInstance;
  for (c4_i6 = 0; c4_i6 < 31; c4_i6++) {
    c4_u[c4_i6] = c4_cv2[c4_i6];
  }
  ...
  c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_SistemaCAS_v19), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_SistemaCAS_v19);
  return c4_y;
}
...
void sf_c4_SistemaCAS_v19_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(558724793U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1776678557U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4127084865U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(136599579U);
}

mxArray *sf_c4_SistemaCAS_v19_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("yD3Q2t7C8c3dbUqWz2rdOF");
...
mxArray *sf_c4_SistemaCAS_v19_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_SistemaCAS_v19_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_SistemaCAS_v19(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"sinal_espalhado1\",},{M[1],M[11],T\"sinal_espalhado2\",},{M[1],M[12],T\"sinal_espalhado3\",},{M[1],M[13],T\"sinal_espalhado4\",},{M[1],M[14],T\"sinal_espalhado5\",},{M[8],M[0],T\"is_active_c4_SistemaCAS_v19\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_SistemaCAS_v19_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_SistemaCAS_v19InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_SistemaCAS_v19MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_SistemaCAS_v19MachineNumber_,
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"sinal_atrasado1");
          _SFD_SET_DATA_PROPS(2,1,1,0,"sinal_atrasado2");
          _SFD_SET_DATA_PROPS(3,1,1,0,"sinal_atrasado3");
          _SFD_SET_DATA_PROPS(4,1,1,0,"sinal_atrasado4");
          _SFD_SET_DATA_PROPS(5,1,1,0,"sinal_atrasado5");
          _SFD_SET_DATA_PROPS(6,2,0,1,"sinal_espalhado1");
          _SFD_SET_DATA_PROPS(7,2,0,1,"sinal_espalhado2");
          _SFD_SET_DATA_PROPS(8,2,0,1,"sinal_espalhado3");
          _SFD_SET_DATA_PROPS(9,2,0,1,"sinal_espalhado4");
          _SFD_SET_DATA_PROPS(10,2,0,1,"sinal_espalhado5");
          _SFD_SET_DATA_PROPS(11,1,1,0,"caminhos");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1640);
...

        {
          ...
          real_T (*c4_caminhos)[5];
          c4_caminhos = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 6);
          c4_sinal_espalhado5 = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            5);
          c4_sinal_espalhado4 = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            4);
          c4_sinal_espalhado3 = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            3);
          c4_sinal_espalhado2 = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            2);
          c4_sinal_espalhado1 = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            1);
          c4_sinal_atrasado5 = (real_T *)ssGetInputPortSignal(chartInstance->S,
            5);
          c4_sinal_atrasado4 = (real_T *)ssGetInputPortSignal(chartInstance->S,
            4);
          c4_sinal_atrasado3 = (real_T *)ssGetInputPortSignal(chartInstance->S,
            3);
          c4_sinal_atrasado2 = (real_T *)ssGetInputPortSignal(chartInstance->S,
            2);
          c4_sinal_atrasado1 = (real_T *)ssGetInputPortSignal(chartInstance->S,
            1);
          c4_k = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c4_k);
          _SFD_SET_DATA_VALUE_PTR(1U, c4_sinal_atrasado1);
          _SFD_SET_DATA_VALUE_PTR(2U, c4_sinal_atrasado2);
          _SFD_SET_DATA_VALUE_PTR(3U, c4_sinal_atrasado3);
          _SFD_SET_DATA_VALUE_PTR(4U, c4_sinal_atrasado4);
          _SFD_SET_DATA_VALUE_PTR(5U, c4_sinal_atrasado5);
          _SFD_SET_DATA_VALUE_PTR(6U, c4_sinal_espalhado1);
          _SFD_SET_DATA_VALUE_PTR(7U, c4_sinal_espalhado2);
          _SFD_SET_DATA_VALUE_PTR(8U, c4_sinal_espalhado3);
          _SFD_SET_DATA_VALUE_PTR(9U, c4_sinal_espalhado4);
          _SFD_SET_DATA_VALUE_PTR(10U, c4_sinal_espalhado5);
          _SFD_SET_DATA_VALUE_PTR(11U, *c4_caminhos);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _SistemaCAS_v19MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "9EQwMa5svlBLssIKeYxDED";
}

static void sf_opaque_initialize_c4_SistemaCAS_v19(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
  initialize_c4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_SistemaCAS_v19(void *chartInstanceVar)
{
  enable_c4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_SistemaCAS_v19(void *chartInstanceVar)
{
  disable_c4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_SistemaCAS_v19(void *chartInstanceVar)
{
  sf_gateway_c4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_SistemaCAS_v19(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_SistemaCAS_v19
    ((SFc4_SistemaCAS_v19InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v19();/* state var info */
...
extern void sf_internal_set_sim_state_c4_SistemaCAS_v19(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v19();/* state var info */
  ...
  set_sim_state_c4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_SistemaCAS_v19(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_SistemaCAS_v19(S);
}

static void sf_opaque_set_sim_state_c4_SistemaCAS_v19(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_SistemaCAS_v19(S, st);
}

static void sf_opaque_terminate_c4_SistemaCAS_v19(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_SistemaCAS_v19InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SistemaCAS_v19_optimization_info();
    }

    finalize_c4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_SistemaCAS_v19((SFc4_SistemaCAS_v19InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_SistemaCAS_v19(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_SistemaCAS_v19(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_SistemaCAS_v19_optimization_info();
  ...
  ssSetChecksum0(S,(953418278U));
  ssSetChecksum1(S,(4239768080U));
  ssSetChecksum2(S,(1740644594U));
  ssSetChecksum3(S,(371211348U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_SistemaCAS_v19(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_SistemaCAS_v19(SimStruct *S)
{
  SFc4_SistemaCAS_v19InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_SistemaCAS_v19InstanceStruct *)utMalloc(sizeof
    (SFc4_SistemaCAS_v19InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_SistemaCAS_v19InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_SistemaCAS_v19;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_SistemaCAS_v19;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_SistemaCAS_v19;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_SistemaCAS_v19;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_SistemaCAS_v19;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_SistemaCAS_v19;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_SistemaCAS_v19;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_SistemaCAS_v19;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_SistemaCAS_v19;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_SistemaCAS_v19;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_SistemaCAS_v19;
...
void c4_SistemaCAS_v19_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_SistemaCAS_v19(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_SistemaCAS_v19(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_SistemaCAS_v19(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_SistemaCAS_v19_method_dispatcher.\n"
