...
static void initialize_c3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
static void initialize_params_c3_SistemaCAS_v20
  (SFc3_SistemaCAS_v20InstanceStruct *chartInstance);
static void enable_c3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
static void disable_c3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_SistemaCAS_v20
  (SFc3_SistemaCAS_v20InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_SistemaCAS_v20
  (SFc3_SistemaCAS_v20InstanceStruct *chartInstance);
static void set_sim_state_c3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
static void sf_gateway_c3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
static void initSimStructsc3_SistemaCAS_v20(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_sinal_absorvido5, const char_T
  *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_alfa, const char_T *c3_identifier, real_T
  c3_y[5]);
static void c3_d_emlrt_marshallIn(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[5]);
...
static real_T c3_sqrt(SFc3_SistemaCAS_v20InstanceStruct *chartInstance, real_T
                      c3_x);
static void c3_eml_error(SFc3_SistemaCAS_v20InstanceStruct *chartInstance);
static real_T c3_mean(SFc3_SistemaCAS_v20InstanceStruct *chartInstance, real_T
                      c3_x[2]);
static real_T c3_mpower(SFc3_SistemaCAS_v20InstanceStruct *chartInstance, real_T
  c3_a);
static void c3_eml_scalar_eg(SFc3_SistemaCAS_v20InstanceStruct *chartInstance);
static real_T c3_log10(SFc3_SistemaCAS_v20InstanceStruct *chartInstance, real_T
  c3_x);
static void c3_b_eml_error(SFc3_SistemaCAS_v20InstanceStruct *chartInstance);
static real_T c3_b_mpower(SFc3_SistemaCAS_v20InstanceStruct *chartInstance,
  real_T c3_a, real_T c3_b);
static void c3_c_eml_error(SFc3_SistemaCAS_v20InstanceStruct *chartInstance);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_e_emlrt_marshallIn(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_f_emlrt_marshallIn(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_SistemaCAS_v20, const char_T *
  c3_identifier);
static uint8_T c3_g_emlrt_marshallIn(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sqrt(SFc3_SistemaCAS_v20InstanceStruct *chartInstance, real_T
                      *c3_x);
static void c3_b_log10(SFc3_SistemaCAS_v20InstanceStruct *chartInstance, real_T *
  c3_x);
static void init_dsm_address_info(SFc3_SistemaCAS_v20InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_SistemaCAS_v20 = 0U;
}
  ...
  (SFc3_SistemaCAS_v20InstanceStruct *chartInstance)
{
  ...
  c3_f_hoistedGlobal = chartInstance->c3_is_active_c3_SistemaCAS_v20;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_sinal_absorvido5 = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_SistemaCAS_v20 = c3_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 6)),
     "is_active_c3_SistemaCAS_v20");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_SistemaCAS_v20(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_SistemaCAS_v20(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_SistemaCAS_v20InstanceStruct *chartInstance;
  chartInstance = (SFc3_SistemaCAS_v20InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_SistemaCAS_v20_get_eml_resolved_functions_info(void)
{
  ...
  c3_identifier)
{
  ...
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_SistemaCAS_v20), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_SistemaCAS_v20);
  return c3_y;
}
...
void sf_c3_SistemaCAS_v20_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_SistemaCAS_v20_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_SistemaCAS_v20_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_SistemaCAS_v20_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_SistemaCAS_v20(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[25],T\"alfa\",},{M[1],M[20],T\"sinal_absorvido1\",},{M[1],M[21],T\"sinal_absorvido2\",},{M[1],M[22],T\"sinal_absorvido3\",},{M[1],M[23],T\"sinal_absorvido4\",},{M[1],M[24],T\"sinal_absorvido5\",},{M[8],M[0],T\"is_active_c3_SistemaCAS_v20\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_SistemaCAS_v20_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SistemaCAS_v20InstanceStruct *)
...
static void sf_opaque_initialize_c3_SistemaCAS_v20(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_SistemaCAS_v20InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*)
    chartInstanceVar);
  initialize_c3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_SistemaCAS_v20(void *chartInstanceVar)
{
  enable_c3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_SistemaCAS_v20(void *chartInstanceVar)
{
  disable_c3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_SistemaCAS_v20(void *chartInstanceVar)
{
  sf_gateway_c3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_SistemaCAS_v20(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_SistemaCAS_v20
    ((SFc3_SistemaCAS_v20InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v20();/* state var info */
...
extern void sf_internal_set_sim_state_c3_SistemaCAS_v20(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v20();/* state var info */
  ...
  set_sim_state_c3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_SistemaCAS_v20(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_SistemaCAS_v20(S);
}

static void sf_opaque_set_sim_state_c3_SistemaCAS_v20(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_SistemaCAS_v20(S, st);
}

static void sf_opaque_terminate_c3_SistemaCAS_v20(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_SistemaCAS_v20InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_SistemaCAS_v20((SFc3_SistemaCAS_v20InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_SistemaCAS_v20(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_SistemaCAS_v20(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_SistemaCAS_v20(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_SistemaCAS_v20(SimStruct *S)
{
  SFc3_SistemaCAS_v20InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_SistemaCAS_v20InstanceStruct *)utMalloc(sizeof
    (SFc3_SistemaCAS_v20InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_SistemaCAS_v20InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_SistemaCAS_v20;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_SistemaCAS_v20;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_SistemaCAS_v20;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_SistemaCAS_v20;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_SistemaCAS_v20;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_SistemaCAS_v20;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_SistemaCAS_v20;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_SistemaCAS_v20;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_SistemaCAS_v20;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_SistemaCAS_v20;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_SistemaCAS_v20;
...
void c3_SistemaCAS_v20_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_SistemaCAS_v20(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_SistemaCAS_v20(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_SistemaCAS_v20(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_SistemaCAS_v20_method_dispatcher.\n"
