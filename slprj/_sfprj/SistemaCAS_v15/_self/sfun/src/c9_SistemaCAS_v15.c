...
static const char * c9_debug_family_names[10] = { "perda_transmissao1",
  "perda_transmissao2", "perda_transmissao3", "perda_transmissao4",
  "perda_transmissao5", "nargin", "nargout", "alfa", "caminhos",
  "perda_transmissao_total" };

/* Function Declarations */
static void initialize_c9_SistemaCAS_v15(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance);
static void initialize_params_c9_SistemaCAS_v15
  (SFc9_SistemaCAS_v15InstanceStruct *chartInstance);
static void enable_c9_SistemaCAS_v15(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance);
static void disable_c9_SistemaCAS_v15(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance);
static void c9_update_debugger_state_c9_SistemaCAS_v15
  (SFc9_SistemaCAS_v15InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_SistemaCAS_v15
  (SFc9_SistemaCAS_v15InstanceStruct *chartInstance);
static void set_sim_state_c9_SistemaCAS_v15(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance, const mxArray *c9_st);
static void finalize_c9_SistemaCAS_v15(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance);
static void sf_gateway_c9_SistemaCAS_v15(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance);
static void initSimStructsc9_SistemaCAS_v15(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance, const mxArray *c9_perda_transmissao_total, const char_T
  *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_SistemaCAS_v15InstanceStruct
...
static real_T c9_log10(SFc9_SistemaCAS_v15InstanceStruct *chartInstance, real_T
  c9_x);
static void c9_eml_error(SFc9_SistemaCAS_v15InstanceStruct *chartInstance);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_d_emlrt_marshallIn(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_SistemaCAS_v15, const char_T *
  c9_identifier);
static uint8_T c9_e_emlrt_marshallIn(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_log10(SFc9_SistemaCAS_v15InstanceStruct *chartInstance, real_T *
  c9_x);
static void init_dsm_address_info(SFc9_SistemaCAS_v15InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_SistemaCAS_v15 = 0U;
}
  ...
  (SFc9_SistemaCAS_v15InstanceStruct *chartInstance)
{
  ...
  real_T *c9_perda_transmissao_total;
  c9_perda_transmissao_total = (real_T *)ssGetOutputPortSignal(chartInstance->S,
    1);
  c9_st = NULL;
  c9_st = NULL;
  c9_y = NULL;
  sf_mex_assign(&c9_y, sf_mex_createcellmatrix(2, 1), false);
  c9_hoistedGlobal = *c9_perda_transmissao_total;
  c9_u = c9_hoistedGlobal;
  c9_b_y = NULL;
  sf_mex_assign(&c9_b_y, sf_mex_create("y", &c9_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c9_y, 0, c9_b_y);
  c9_b_hoistedGlobal = chartInstance->c9_is_active_c9_SistemaCAS_v15;
  ...
  *chartInstance, const mxArray *c9_st)
{
  ...
  *c9_perda_transmissao_total = c9_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c9_u, 0)), "perda_transmissao_total");
  chartInstance->c9_is_active_c9_SistemaCAS_v15 = c9_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 1)),
     "is_active_c9_SistemaCAS_v15");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_SistemaCAS_v15(chartInstance);
  ...
  *chartInstance)
{
  ...
  int32_T c9_i1;
  real_T *c9_b_alfa;
  real_T *c9_b_perda_transmissao_total;
  real_T (*c9_b_caminhos)[5];
  c9_b_caminhos = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
  c9_b_perda_transmissao_total = (real_T *)ssGetOutputPortSignal
    (chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao1, 0U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao2, 1U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao3, 2U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao4, 3U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao5, 4U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_nargout, 6U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c9_alfa, 7U, c9_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c9_caminhos, 8U, c9_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao_total, 9U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c9_perda_transmissao_total = (((c9_perda_transmissao1 + c9_perda_transmissao2)
    + c9_perda_transmissao3) + c9_perda_transmissao4) + c9_perda_transmissao5;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, -15);
  _SFD_SYMBOL_SCOPE_POP();
  *c9_b_perda_transmissao_total = c9_perda_transmissao_total;
  ...
  _SFD_DATA_RANGE_CHECK(*c9_b_perda_transmissao_total, 1U);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_SistemaCAS_v15InstanceStruct *chartInstance;
  chartInstance = (SFc9_SistemaCAS_v15InstanceStruct *)chartInstanceVoid;
  ...
  *c9_identifier)
{
  ...
  c9_y = c9_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_perda_transmissao_total), &c9_thisId);
  sf_mex_destroy(&c9_perda_transmissao_total);
  return c9_y;
}
...
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData)
{
  const mxArray *c9_perda_transmissao_total;
  const char_T *c9_identifier;
  emlrtMsgIdentifier c9_thisId;
  real_T c9_y;
  SFc9_SistemaCAS_v15InstanceStruct *chartInstance;
  chartInstance = (SFc9_SistemaCAS_v15InstanceStruct *)chartInstanceVoid;
  c9_perda_transmissao_total = sf_mex_dup(c9_mxArrayInData);
...
const mxArray *sf_c9_SistemaCAS_v15_get_eml_resolved_functions_info(void)
{
  ...
  c9_identifier)
{
  ...
  c9_y = c9_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_SistemaCAS_v15), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_SistemaCAS_v15);
  return c9_y;
}
...
void sf_c9_SistemaCAS_v15_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2476925082U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4176489956U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1239580176U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1238986965U);
}

mxArray *sf_c9_SistemaCAS_v15_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("mDS8t0441232GpwTT1gIkH");
...
mxArray *sf_c9_SistemaCAS_v15_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_SistemaCAS_v15_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c9_SistemaCAS_v15(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"perda_transmissao_total\",},{M[8],M[0],T\"is_active_c9_SistemaCAS_v15\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_SistemaCAS_v15_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_SistemaCAS_v15InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"perda_transmissao_total");
...

        {
          ...
          c9_perda_transmissao_total = (real_T *)ssGetOutputPortSignal
            (chartInstance->S, 1);
          c9_alfa = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c9_alfa);
          _SFD_SET_DATA_VALUE_PTR(1U, c9_perda_transmissao_total);
...
{
  return "3x9HB7dsHK3Yafsoeiij2G";
}

static void sf_opaque_initialize_c9_SistemaCAS_v15(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_SistemaCAS_v15InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*)
    chartInstanceVar);
  initialize_c9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_SistemaCAS_v15(void *chartInstanceVar)
{
  enable_c9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_SistemaCAS_v15(void *chartInstanceVar)
{
  disable_c9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_SistemaCAS_v15(void *chartInstanceVar)
{
  sf_gateway_c9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_SistemaCAS_v15(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_SistemaCAS_v15
    ((SFc9_SistemaCAS_v15InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v15();/* state var info */
...
extern void sf_internal_set_sim_state_c9_SistemaCAS_v15(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v15();/* state var info */
  ...
  set_sim_state_c9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_SistemaCAS_v15(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_SistemaCAS_v15(S);
}

static void sf_opaque_set_sim_state_c9_SistemaCAS_v15(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_SistemaCAS_v15(S, st);
}

static void sf_opaque_terminate_c9_SistemaCAS_v15(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_SistemaCAS_v15InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_SistemaCAS_v15((SFc9_SistemaCAS_v15InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_SistemaCAS_v15(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_SistemaCAS_v15(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3172536490U));
  ssSetChecksum1(S,(552869450U));
  ssSetChecksum2(S,(2045815198U));
  ssSetChecksum3(S,(2345729254U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c9_SistemaCAS_v15(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_SistemaCAS_v15(SimStruct *S)
{
  SFc9_SistemaCAS_v15InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_SistemaCAS_v15InstanceStruct *)utMalloc(sizeof
    (SFc9_SistemaCAS_v15InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_SistemaCAS_v15InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_SistemaCAS_v15;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_SistemaCAS_v15;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_SistemaCAS_v15;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_SistemaCAS_v15;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_SistemaCAS_v15;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_SistemaCAS_v15;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_SistemaCAS_v15;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_SistemaCAS_v15;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_SistemaCAS_v15;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_SistemaCAS_v15;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_SistemaCAS_v15;
...
void c9_SistemaCAS_v15_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_SistemaCAS_v15(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_SistemaCAS_v15(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_SistemaCAS_v15(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_SistemaCAS_v15_method_dispatcher.\n"
