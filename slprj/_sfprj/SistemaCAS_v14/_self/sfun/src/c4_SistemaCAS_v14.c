...
static const char * c4_debug_family_names[19] = { "espalhamento1",
  "espalhamento2", "espalhamento3", "espalhamento4", "espalhamento5", "nargin",
  "nargout", "k", "sinal_atrasado1", "sinal_atrasado2", "sinal_atrasado3",
  "sinal_atrasado4", "sinal_atrasado5", "caminhos", "sinal_espalhado1",
  "sinal_espalhado2", "sinal_espalhado3", "sinal_espalhado4", "sinal_espalhado5"
};

/* Function Declarations */
static void initialize_c4_SistemaCAS_v14(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void initialize_params_c4_SistemaCAS_v14
  (SFc4_SistemaCAS_v14InstanceStruct *chartInstance);
static void enable_c4_SistemaCAS_v14(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void disable_c4_SistemaCAS_v14(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_SistemaCAS_v14
  (SFc4_SistemaCAS_v14InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_SistemaCAS_v14
  (SFc4_SistemaCAS_v14InstanceStruct *chartInstance);
static void set_sim_state_c4_SistemaCAS_v14(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_SistemaCAS_v14(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance);
...
static real_T c4_emlrt_marshallIn(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c4_sinal_espalhado5, const char_T
  *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_SistemaCAS_v14InstanceStruct
...
static real_T c4_log10(SFc4_SistemaCAS_v14InstanceStruct *chartInstance, real_T
  c4_x);
static void c4_eml_error(SFc4_SistemaCAS_v14InstanceStruct *chartInstance);
static real_T c4_mpower(SFc4_SistemaCAS_v14InstanceStruct *chartInstance, real_T
  c4_a, real_T c4_b);
static void c4_eml_scalar_eg(SFc4_SistemaCAS_v14InstanceStruct *chartInstance);
static void c4_b_eml_error(SFc4_SistemaCAS_v14InstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_SistemaCAS_v14, const char_T *
  c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_log10(SFc4_SistemaCAS_v14InstanceStruct *chartInstance, real_T *
  c4_x);
static void init_dsm_address_info(SFc4_SistemaCAS_v14InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_SistemaCAS_v14 = 0U;
}
  ...
  (SFc4_SistemaCAS_v14InstanceStruct *chartInstance)
{
  ...
  c4_f_hoistedGlobal = chartInstance->c4_is_active_c4_SistemaCAS_v14;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_sinal_espalhado5 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_SistemaCAS_v14 = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 5)),
     "is_active_c4_SistemaCAS_v14");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_SistemaCAS_v14(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c4_espalhamento2;
  real_T c4_espalhamento3;
  real_T c4_espalhamento4;
  real_T c4_espalhamento5;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_espalhamento1, 0U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_espalhamento2, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_espalhamento3, 2U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_espalhamento4, 3U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_espalhamento5, 4U, c4_sf_marshallOut,
    c4_sf_marshallIn);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_SistemaCAS_v14InstanceStruct *chartInstance;
  chartInstance = (SFc4_SistemaCAS_v14InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_SistemaCAS_v14_get_eml_resolved_functions_info(void)
{
  ...
  c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_SistemaCAS_v14), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_SistemaCAS_v14);
  return c4_y;
}
...
mxArray *sf_c4_SistemaCAS_v14_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_SistemaCAS_v14_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_SistemaCAS_v14(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"sinal_espalhado1\",},{M[1],M[11],T\"sinal_espalhado2\",},{M[1],M[12],T\"sinal_espalhado3\",},{M[1],M[13],T\"sinal_espalhado4\",},{M[1],M[14],T\"sinal_espalhado5\",},{M[8],M[0],T\"is_active_c4_SistemaCAS_v14\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_SistemaCAS_v14_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_SistemaCAS_v14InstanceStruct *)
...
{
  chart_debug_initialization(((SFc4_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
  initialize_c4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_SistemaCAS_v14(void *chartInstanceVar)
{
  enable_c4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_SistemaCAS_v14(void *chartInstanceVar)
{
  disable_c4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_SistemaCAS_v14(void *chartInstanceVar)
{
  sf_gateway_c4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_SistemaCAS_v14(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_SistemaCAS_v14
    ((SFc4_SistemaCAS_v14InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v14();/* state var info */
...
extern void sf_internal_set_sim_state_c4_SistemaCAS_v14(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v14();/* state var info */
  ...
  set_sim_state_c4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_SistemaCAS_v14(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_SistemaCAS_v14(S);
}

static void sf_opaque_set_sim_state_c4_SistemaCAS_v14(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_SistemaCAS_v14(S, st);
}

static void sf_opaque_terminate_c4_SistemaCAS_v14(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_SistemaCAS_v14InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_SistemaCAS_v14((SFc4_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_SistemaCAS_v14(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_SistemaCAS_v14(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_SistemaCAS_v14(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_SistemaCAS_v14(SimStruct *S)
{
  SFc4_SistemaCAS_v14InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_SistemaCAS_v14InstanceStruct *)utMalloc(sizeof
    (SFc4_SistemaCAS_v14InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_SistemaCAS_v14InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_SistemaCAS_v14;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_SistemaCAS_v14;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_SistemaCAS_v14;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_SistemaCAS_v14;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_SistemaCAS_v14;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_SistemaCAS_v14;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_SistemaCAS_v14;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_SistemaCAS_v14;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_SistemaCAS_v14;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_SistemaCAS_v14;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_SistemaCAS_v14;
...
void c4_SistemaCAS_v14_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_SistemaCAS_v14(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_SistemaCAS_v14(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_SistemaCAS_v14(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_SistemaCAS_v14_method_dispatcher.\n"
