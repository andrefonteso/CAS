...
static const char * c3_debug_family_names[29] = { "T", "S", "pH", "D", "f1",
  "f2", "a", "atenuacao1", "atenuacao2", "atenuacao3", "atenuacao4",
  "atenuacao5", "sinal_atenuado1", "sinal_atenuado2", "sinal_atenuado3",
  "sinal_atenuado4", "sinal_atenuado5", "nargin", "nargout",
  "parametros_aquario", "parametros_ambientais", "frequencia",
  "sinal_espalhado1", "sinal_espalhado2", "sinal_espalhado3", "sinal_espalhado4",
  "sinal_espalhado5", "caminhos", "sinal_atenuado_total" };

/* Function Declarations */
static void initialize_c3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void initialize_params_c3_SistemaCAS_v14
  (SFc3_SistemaCAS_v14InstanceStruct *chartInstance);
static void enable_c3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void disable_c3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_SistemaCAS_v14
  (SFc3_SistemaCAS_v14InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_SistemaCAS_v14
  (SFc3_SistemaCAS_v14InstanceStruct *chartInstance);
static void set_sim_state_c3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void sf_gateway_c3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void initSimStructsc3_SistemaCAS_v14(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c3_sinal_atenuado_total, const char_T
  *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_SistemaCAS_v14InstanceStruct
...
static real_T c3_sqrt(SFc3_SistemaCAS_v14InstanceStruct *chartInstance, real_T
                      c3_x);
static void c3_eml_error(SFc3_SistemaCAS_v14InstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_SistemaCAS_v14InstanceStruct *chartInstance, real_T
  c3_a);
static void c3_eml_scalar_eg(SFc3_SistemaCAS_v14InstanceStruct *chartInstance);
static real_T c3_log10(SFc3_SistemaCAS_v14InstanceStruct *chartInstance, real_T
  c3_x);
static void c3_b_eml_error(SFc3_SistemaCAS_v14InstanceStruct *chartInstance);
static real_T c3_b_mpower(SFc3_SistemaCAS_v14InstanceStruct *chartInstance,
  real_T c3_a, real_T c3_b);
static void c3_c_eml_error(SFc3_SistemaCAS_v14InstanceStruct *chartInstance);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_SistemaCAS_v14, const char_T *
  c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sqrt(SFc3_SistemaCAS_v14InstanceStruct *chartInstance, real_T
                      *c3_x);
static void c3_b_log10(SFc3_SistemaCAS_v14InstanceStruct *chartInstance, real_T *
  c3_x);
static void init_dsm_address_info(SFc3_SistemaCAS_v14InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_SistemaCAS_v14 = 0U;
}
  ...
  (SFc3_SistemaCAS_v14InstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_SistemaCAS_v14;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_sinal_atenuado_total = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_SistemaCAS_v14 = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_SistemaCAS_v14");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_SistemaCAS_v14(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c3_sinal_espalhado1, 3U);
  _SFD_DATA_RANGE_CHECK(*c3_sinal_espalhado2, 4U);
  _SFD_DATA_RANGE_CHECK(*c3_sinal_espalhado3, 5U);
  _SFD_DATA_RANGE_CHECK(*c3_sinal_espalhado4, 6U);
  _SFD_DATA_RANGE_CHECK(*c3_sinal_espalhado5, 7U);
  for (c3_i2 = 0; c3_i2 < 5; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((*c3_caminhos)[c3_i2], 8U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_SistemaCAS_v14(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v14MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c3_sinal_atenuado_total, 9U);
}
  ...
  *chartInstance)
{
  ...
  real_T c3_f2;
  real_T c3_a;
  real_T c3_atenuacao1;
  real_T c3_atenuacao2;
  real_T c3_atenuacao3;
  real_T c3_atenuacao4;
  real_T c3_atenuacao5;
  real_T c3_sinal_atenuado1;
  real_T c3_sinal_atenuado2;
  real_T c3_sinal_atenuado3;
  real_T c3_sinal_atenuado4;
  real_T c3_sinal_atenuado5;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_a, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacao1, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacao2, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacao3, 9U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacao4, 10U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_atenuacao5, 11U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado1, 12U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado2, 13U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado3, 14U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado4, 15U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_sinal_atenuado5, 16U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 18U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_parametros_aquario, 19U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_parametros_ambientais, 20U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_frequencia, 21U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado1, 22U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado2, 23U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado3, 24U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado4, 25U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_sinal_espalhado5, 26U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_caminhos, 27U, c3_b_sf_marshallOut);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_SistemaCAS_v14InstanceStruct *chartInstance;
  chartInstance = (SFc3_SistemaCAS_v14InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_SistemaCAS_v14_get_eml_resolved_functions_info(void)
{
  ...
  c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_SistemaCAS_v14), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_SistemaCAS_v14);
  return c3_y;
}
...
mxArray *sf_c3_SistemaCAS_v14_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_SistemaCAS_v14_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_SistemaCAS_v14(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[20],T\"sinal_atenuado_total\",},{M[8],M[0],T\"is_active_c3_SistemaCAS_v14\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_SistemaCAS_v14_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SistemaCAS_v14InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,1,1,0,"sinal_espalhado1");
          _SFD_SET_DATA_PROPS(4,1,1,0,"sinal_espalhado2");
          _SFD_SET_DATA_PROPS(5,1,1,0,"sinal_espalhado3");
          _SFD_SET_DATA_PROPS(6,1,1,0,"sinal_espalhado4");
          _SFD_SET_DATA_PROPS(7,1,1,0,"sinal_espalhado5");
          _SFD_SET_DATA_PROPS(8,1,1,0,"caminhos");
          _SFD_SET_DATA_PROPS(9,2,0,1,"sinal_atenuado_total");
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(3U, c3_sinal_espalhado1);
          _SFD_SET_DATA_VALUE_PTR(4U, c3_sinal_espalhado2);
          _SFD_SET_DATA_VALUE_PTR(5U, c3_sinal_espalhado3);
          _SFD_SET_DATA_VALUE_PTR(6U, c3_sinal_espalhado4);
          _SFD_SET_DATA_VALUE_PTR(7U, c3_sinal_espalhado5);
          _SFD_SET_DATA_VALUE_PTR(8U, *c3_caminhos);
          _SFD_SET_DATA_VALUE_PTR(9U, c3_sinal_atenuado_total);
        }
      }
    } else {
...
{
  chart_debug_initialization(((SFc3_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
  initialize_c3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_SistemaCAS_v14(void *chartInstanceVar)
{
  enable_c3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_SistemaCAS_v14(void *chartInstanceVar)
{
  disable_c3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_SistemaCAS_v14(void *chartInstanceVar)
{
  sf_gateway_c3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_SistemaCAS_v14(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_SistemaCAS_v14
    ((SFc3_SistemaCAS_v14InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v14();/* state var info */
...
extern void sf_internal_set_sim_state_c3_SistemaCAS_v14(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_SistemaCAS_v14();/* state var info */
  ...
  set_sim_state_c3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_SistemaCAS_v14(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_SistemaCAS_v14(S);
}

static void sf_opaque_set_sim_state_c3_SistemaCAS_v14(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_SistemaCAS_v14(S, st);
}

static void sf_opaque_terminate_c3_SistemaCAS_v14(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_SistemaCAS_v14InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_SistemaCAS_v14((SFc3_SistemaCAS_v14InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_SistemaCAS_v14(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_SistemaCAS_v14(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_SistemaCAS_v14(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_SistemaCAS_v14(SimStruct *S)
{
  SFc3_SistemaCAS_v14InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_SistemaCAS_v14InstanceStruct *)utMalloc(sizeof
    (SFc3_SistemaCAS_v14InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_SistemaCAS_v14InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_SistemaCAS_v14;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_SistemaCAS_v14;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_SistemaCAS_v14;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_SistemaCAS_v14;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_SistemaCAS_v14;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_SistemaCAS_v14;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_SistemaCAS_v14;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_SistemaCAS_v14;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_SistemaCAS_v14;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_SistemaCAS_v14;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_SistemaCAS_v14;
...
void c3_SistemaCAS_v14_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_SistemaCAS_v14(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_SistemaCAS_v14(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_SistemaCAS_v14(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_SistemaCAS_v14_method_dispatcher.\n"
