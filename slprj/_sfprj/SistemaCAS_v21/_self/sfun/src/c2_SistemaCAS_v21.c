...
static const char * c2_debug_family_names[20] = { "W", "L", "D", "T", "S", "pH",
  "distancias", "Dm", "C", "i", "nargin", "nargout", "parametros_aquario",
  "parametros_ambientais", "atraso1", "atraso2", "atraso3", "atraso4", "atraso5",
  "caminhos" };

/* Function Declarations */
static void initialize_c2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initialize_params_c2_SistemaCAS_v21
  (SFc2_SistemaCAS_v21InstanceStruct *chartInstance);
static void enable_c2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void disable_c2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_SistemaCAS_v21
  (SFc2_SistemaCAS_v21InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SistemaCAS_v21
  (SFc2_SistemaCAS_v21InstanceStruct *chartInstance);
static void set_sim_state_c2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void sf_gateway_c2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void c2_chartstep_c2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initSimStructsc2_SistemaCAS_v21(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_SistemaCAS_v21InstanceStruct *chartInstance,
  const mxArray *c2_caminhos, const char_T *c2_identifier, real_T c2_y[5]);
static void c2_b_emlrt_marshallIn(SFc2_SistemaCAS_v21InstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c2_atraso5, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static real_T c2_mpower(SFc2_SistemaCAS_v21InstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_SistemaCAS_v21InstanceStruct *chartInstance);
static real_T c2_sqrt(SFc2_SistemaCAS_v21InstanceStruct *chartInstance, real_T
                      c2_x);
static void c2_eml_error(SFc2_SistemaCAS_v21InstanceStruct *chartInstance);
static real_T c2_mean(SFc2_SistemaCAS_v21InstanceStruct *chartInstance, real_T
                      c2_x[2]);
static real_T c2_b_mpower(SFc2_SistemaCAS_v21InstanceStruct *chartInstance,
  real_T c2_a);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_SistemaCAS_v21, const char_T *
  c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_SistemaCAS_v21InstanceStruct *chartInstance, real_T
                      *c2_x);
static void init_dsm_address_info(SFc2_SistemaCAS_v21InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SistemaCAS_v21 = 0U;
}
  ...
  (SFc2_SistemaCAS_v21InstanceStruct *chartInstance)
{
  ...
  c2_f_hoistedGlobal = chartInstance->c2_is_active_c2_SistemaCAS_v21;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_atraso5 = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_SistemaCAS_v21 = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 6)),
     "is_active_c2_SistemaCAS_v21");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SistemaCAS_v21(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_SistemaCAS_v21(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_pH, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_distancias, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Dm, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_C, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_i, 9U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso1, 14U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso2, 15U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso3, 16U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso4, 17U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_atraso5, 18U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_caminhos, 19U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i7 = 0; c2_i7 < 5; c2_i7++) {
    c2_distancias[c2_i7] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 31);
  c2_distancias[0] = c2_mpower(chartInstance, c2_D) + c2_mpower(chartInstance,
    c2_L);
  c2_b_sqrt(chartInstance, &c2_distancias[0]);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 32);
  c2_distancias[1] = c2_mpower(chartInstance, c2_W) + c2_mpower(chartInstance,
    c2_L);
  c2_b_sqrt(chartInstance, &c2_distancias[1]);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 33);
  c2_distancias[2] = c2_L;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 34);
  c2_distancias[3] = c2_mpower(chartInstance, c2_W) + c2_mpower(chartInstance,
    c2_L);
  c2_b_sqrt(chartInstance, &c2_distancias[3]);
  ...
  c2_t_x = c2_s_x;
  c2_i_y = c2_h_y;
  c2_atraso1 = c2_t_x / c2_i_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 68);
  c2_g_A = c2_distancias[1];
  c2_b_B = c2_C[1];
  c2_u_x = c2_g_A;
  c2_j_y = c2_b_B;
  c2_v_x = c2_u_x;
  ...
  c2_w_x = c2_v_x;
  c2_l_y = c2_k_y;
  c2_atraso2 = c2_w_x / c2_l_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 69);
  c2_h_A = c2_distancias[2];
  c2_c_B = c2_C[2];
  c2_x_x = c2_h_A;
  c2_m_y = c2_c_B;
  c2_y_x = c2_x_x;
  ...
  c2_ab_x = c2_y_x;
  c2_o_y = c2_n_y;
  c2_atraso3 = c2_ab_x / c2_o_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 70);
  c2_i_A = c2_distancias[3];
  c2_d_B = c2_C[3];
  c2_bb_x = c2_i_A;
  c2_p_y = c2_d_B;
  c2_cb_x = c2_bb_x;
  ...
  c2_db_x = c2_cb_x;
  c2_r_y = c2_q_y;
  c2_atraso4 = c2_db_x / c2_r_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 71);
  c2_j_A = c2_distancias[4];
  c2_e_B = c2_C[4];
  c2_eb_x = c2_j_A;
  c2_s_y = c2_e_B;
  c2_fb_x = c2_eb_x;
  ...
  *c2_b_atraso5 = c2_atraso5;
  for (c2_i11 = 0; c2_i11 < 5; c2_i11++) {
    (*c2_b_caminhos)[c2_i11] = c2_caminhos[c2_i11];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SistemaCAS_v21InstanceStruct *chartInstance;
  chartInstance = (SFc2_SistemaCAS_v21InstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i12 = 0; c2_i12 < 5; c2_i12++) {
    c2_b_inData[c2_i12] = (*(real_T (*)[5])c2_inData)[c2_i12];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i15 = 0; c2_i15 < 5; c2_i15++) {
    (*(real_T (*)[5])c2_outData)[c2_i15] = c2_y[c2_i15];
  }
...
const mxArray *sf_c2_SistemaCAS_v21_get_eml_resolved_functions_info(void)
{
  ...
  c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SistemaCAS_v21), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SistemaCAS_v21);
  return c2_y;
}
...
void sf_c2_SistemaCAS_v21_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4260492279U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(92291245U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4007467745U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1038012959U);
}

mxArray *sf_c2_SistemaCAS_v21_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9YwwWltZpOCh47Ma5OHXgG");
...
mxArray *sf_c2_SistemaCAS_v21_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_SistemaCAS_v21_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_SistemaCAS_v21(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[10],T\"atraso1\",},{M[1],M[11],T\"atraso2\",},{M[1],M[12],T\"atraso3\",},{M[1],M[13],T\"atraso4\",},{M[1],M[14],T\"atraso5\",},{M[1],M[18],T\"caminhos\",},{M[8],M[0],T\"is_active_c2_SistemaCAS_v21\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SistemaCAS_v21_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_SistemaCAS_v21InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,3283);
        _SFD_CV_INIT_EML_FOR(0,1,0,2373,2385,2644);
...
{
  return "wCogUrZmGn6LhSvbs5EVMB";
}

static void sf_opaque_initialize_c2_SistemaCAS_v21(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
  initialize_c2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_SistemaCAS_v21(void *chartInstanceVar)
{
  enable_c2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_SistemaCAS_v21(void *chartInstanceVar)
{
  disable_c2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_SistemaCAS_v21(void *chartInstanceVar)
{
  sf_gateway_c2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_SistemaCAS_v21(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SistemaCAS_v21
    ((SFc2_SistemaCAS_v21InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_SistemaCAS_v21();/* state var info */
...
extern void sf_internal_set_sim_state_c2_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_SistemaCAS_v21();/* state var info */
  ...
  set_sim_state_c2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_SistemaCAS_v21(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SistemaCAS_v21(S);
}

static void sf_opaque_set_sim_state_c2_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_SistemaCAS_v21(S, st);
}

static void sf_opaque_terminate_c2_SistemaCAS_v21(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SistemaCAS_v21InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_SistemaCAS_v21((SFc2_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SistemaCAS_v21(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(876958472U));
  ssSetChecksum1(S,(2299208343U));
  ssSetChecksum2(S,(2805049870U));
  ssSetChecksum3(S,(1092086345U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_SistemaCAS_v21(SimStruct *S)
{
  SFc2_SistemaCAS_v21InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_SistemaCAS_v21InstanceStruct *)utMalloc(sizeof
    (SFc2_SistemaCAS_v21InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_SistemaCAS_v21InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_SistemaCAS_v21;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SistemaCAS_v21;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_SistemaCAS_v21;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_SistemaCAS_v21;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_SistemaCAS_v21;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SistemaCAS_v21;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SistemaCAS_v21;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SistemaCAS_v21;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SistemaCAS_v21;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SistemaCAS_v21;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_SistemaCAS_v21;
...
void c2_SistemaCAS_v21_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SistemaCAS_v21(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SistemaCAS_v21_method_dispatcher.\n"
