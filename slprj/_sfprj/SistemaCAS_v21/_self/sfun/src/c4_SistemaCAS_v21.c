...
static void initialize_c4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initialize_params_c4_SistemaCAS_v21
  (SFc4_SistemaCAS_v21InstanceStruct *chartInstance);
static void enable_c4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void disable_c4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_SistemaCAS_v21
  (SFc4_SistemaCAS_v21InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_SistemaCAS_v21
  (SFc4_SistemaCAS_v21InstanceStruct *chartInstance);
static void set_sim_state_c4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void sf_gateway_c4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void c4_chartstep_c4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initSimStructsc4_SistemaCAS_v21(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c4_sinal_espalhado5, const char_T
  *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_SistemaCAS_v21InstanceStruct
...
static real_T c4_log10(SFc4_SistemaCAS_v21InstanceStruct *chartInstance, real_T
  c4_x);
static void c4_eml_error(SFc4_SistemaCAS_v21InstanceStruct *chartInstance);
static real_T c4_mpower(SFc4_SistemaCAS_v21InstanceStruct *chartInstance, real_T
  c4_a, real_T c4_b);
static void c4_eml_scalar_eg(SFc4_SistemaCAS_v21InstanceStruct *chartInstance);
static void c4_b_eml_error(SFc4_SistemaCAS_v21InstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_SistemaCAS_v21, const char_T *
  c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_log10(SFc4_SistemaCAS_v21InstanceStruct *chartInstance, real_T *
  c4_x);
static void init_dsm_address_info(SFc4_SistemaCAS_v21InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_SistemaCAS_v21 = 0U;
}
  ...
  (SFc4_SistemaCAS_v21InstanceStruct *chartInstance)
{
  ...
  c4_f_hoistedGlobal = chartInstance->c4_is_active_c4_SistemaCAS_v21;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_sinal_espalhado5 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_SistemaCAS_v21 = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 5)),
     "is_active_c4_SistemaCAS_v21");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_SistemaCAS_v21(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_SistemaCAS_v21(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SistemaCAS_v21MachineNumber_,
  ...
  *chartInstance)
{
  ...
  c4_c_x = c4_b_x;
  c4_c_y = c4_c_x / 10.0;
  c4_sinal_espalhado1 = c4_sinal_atrasado1 * c4_mpower(chartInstance, 10.0,
    c4_c_y);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_SistemaCAS_v21InstanceStruct *chartInstance;
  chartInstance = (SFc4_SistemaCAS_v21InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_SistemaCAS_v21_get_eml_resolved_functions_info(void)
{
  ...
  c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_SistemaCAS_v21), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_SistemaCAS_v21);
  return c4_y;
}
...
void sf_c4_SistemaCAS_v21_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3110346813U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2230310734U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1373375901U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3620999427U);
}

mxArray *sf_c4_SistemaCAS_v21_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("pEHcMZvjZJhtabXdYAiQiB");
...
mxArray *sf_c4_SistemaCAS_v21_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_SistemaCAS_v21_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_SistemaCAS_v21(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"sinal_espalhado1\",},{M[1],M[11],T\"sinal_espalhado2\",},{M[1],M[12],T\"sinal_espalhado3\",},{M[1],M[13],T\"sinal_espalhado4\",},{M[1],M[14],T\"sinal_espalhado5\",},{M[8],M[0],T\"is_active_c4_SistemaCAS_v21\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_SistemaCAS_v21_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_SistemaCAS_v21InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_SistemaCAS_v21MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_SistemaCAS_v21MachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1572);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _SistemaCAS_v21MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "RuP3UzUk1T3Z8HZLaTS24B";
}

static void sf_opaque_initialize_c4_SistemaCAS_v21(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
  initialize_c4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_SistemaCAS_v21(void *chartInstanceVar)
{
  enable_c4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_SistemaCAS_v21(void *chartInstanceVar)
{
  disable_c4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_SistemaCAS_v21(void *chartInstanceVar)
{
  sf_gateway_c4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_SistemaCAS_v21(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_SistemaCAS_v21
    ((SFc4_SistemaCAS_v21InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v21();/* state var info */
...
extern void sf_internal_set_sim_state_c4_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_SistemaCAS_v21();/* state var info */
  ...
  set_sim_state_c4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_SistemaCAS_v21(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_SistemaCAS_v21(S);
}

static void sf_opaque_set_sim_state_c4_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_SistemaCAS_v21(S, st);
}

static void sf_opaque_terminate_c4_SistemaCAS_v21(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_SistemaCAS_v21InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SistemaCAS_v21_optimization_info();
    }

    finalize_c4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_SistemaCAS_v21((SFc4_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_SistemaCAS_v21(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_SistemaCAS_v21_optimization_info();
  ...
  ssSetChecksum0(S,(3106968739U));
  ssSetChecksum1(S,(916471483U));
  ssSetChecksum2(S,(275327345U));
  ssSetChecksum3(S,(4021484220U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_SistemaCAS_v21(SimStruct *S)
{
  SFc4_SistemaCAS_v21InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_SistemaCAS_v21InstanceStruct *)utMalloc(sizeof
    (SFc4_SistemaCAS_v21InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_SistemaCAS_v21InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_SistemaCAS_v21;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_SistemaCAS_v21;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_SistemaCAS_v21;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_SistemaCAS_v21;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_SistemaCAS_v21;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_SistemaCAS_v21;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_SistemaCAS_v21;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_SistemaCAS_v21;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_SistemaCAS_v21;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_SistemaCAS_v21;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_SistemaCAS_v21;
...
void c4_SistemaCAS_v21_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_SistemaCAS_v21(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_SistemaCAS_v21_method_dispatcher.\n"
