...
static void initialize_c1_SistemaCAS_v21(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initialize_params_c1_SistemaCAS_v21
  (SFc1_SistemaCAS_v21InstanceStruct *chartInstance);
static void enable_c1_SistemaCAS_v21(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void disable_c1_SistemaCAS_v21(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_SistemaCAS_v21
  (SFc1_SistemaCAS_v21InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_SistemaCAS_v21
  (SFc1_SistemaCAS_v21InstanceStruct *chartInstance);
static void set_sim_state_c1_SistemaCAS_v21(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_SistemaCAS_v21(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void sf_gateway_c1_SistemaCAS_v21(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initSimStructsc1_SistemaCAS_v21(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_SistemaCAS_v21InstanceStruct *chartInstance,
  const mxArray *c1_parametros_ambientais, const char_T *c1_identifier, real_T
  c1_y[3]);
static void c1_b_emlrt_marshallIn(SFc1_SistemaCAS_v21InstanceStruct
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_SistemaCAS_v21, const char_T *
  c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_SistemaCAS_v21InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_SistemaCAS_v21 = 0U;
}
  ...
  (SFc1_SistemaCAS_v21InstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_SistemaCAS_v21;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_SistemaCAS_v21 = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_SistemaCAS_v21");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_SistemaCAS_v21(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_SistemaCAS_v21InstanceStruct *chartInstance;
  chartInstance = (SFc1_SistemaCAS_v21InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_SistemaCAS_v21_get_eml_resolved_functions_info(void)
{
  ...
  c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_SistemaCAS_v21), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_SistemaCAS_v21);
  return c1_y;
}
...
void sf_c1_SistemaCAS_v21_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_SistemaCAS_v21_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_SistemaCAS_v21_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_SistemaCAS_v21_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_SistemaCAS_v21(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[15],T\"parametros_ambientais\",},{M[1],M[11],T\"parametros_aquario\",},{M[8],M[0],T\"is_active_c1_SistemaCAS_v21\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_SistemaCAS_v21_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_SistemaCAS_v21InstanceStruct *)
...
static void sf_opaque_initialize_c1_SistemaCAS_v21(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
  initialize_c1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_SistemaCAS_v21(void *chartInstanceVar)
{
  enable_c1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_SistemaCAS_v21(void *chartInstanceVar)
{
  disable_c1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_SistemaCAS_v21(void *chartInstanceVar)
{
  sf_gateway_c1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_SistemaCAS_v21(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_SistemaCAS_v21
    ((SFc1_SistemaCAS_v21InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_SistemaCAS_v21();/* state var info */
...
extern void sf_internal_set_sim_state_c1_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_SistemaCAS_v21();/* state var info */
  ...
  set_sim_state_c1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_SistemaCAS_v21(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_SistemaCAS_v21(S);
}

static void sf_opaque_set_sim_state_c1_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_SistemaCAS_v21(S, st);
}

static void sf_opaque_terminate_c1_SistemaCAS_v21(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_SistemaCAS_v21InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_SistemaCAS_v21((SFc1_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_SistemaCAS_v21(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_SistemaCAS_v21(SimStruct *S)
{
  SFc1_SistemaCAS_v21InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_SistemaCAS_v21InstanceStruct *)utMalloc(sizeof
    (SFc1_SistemaCAS_v21InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_SistemaCAS_v21InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_SistemaCAS_v21;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_SistemaCAS_v21;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_SistemaCAS_v21;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_SistemaCAS_v21;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_SistemaCAS_v21;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_SistemaCAS_v21;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_SistemaCAS_v21;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_SistemaCAS_v21;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_SistemaCAS_v21;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_SistemaCAS_v21;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_SistemaCAS_v21;
...
void c1_SistemaCAS_v21_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_SistemaCAS_v21(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_SistemaCAS_v21_method_dispatcher.\n"
