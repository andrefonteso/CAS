...
static const char * c9_debug_family_names[20] = { "espgeo1", "espgeo2",
  "espgeo3", "espgeo4", "espgeo5", "abs1", "abs2", "abs3", "abs4", "abs5",
  "nargin", "nargout", "k", "alfa", "caminhos", "perda_transmissao1",
  "perda_transmissao2", "perda_transmissao3", "perda_transmissao4",
  "perda_transmissao5" };

/* Function Declarations */
static void initialize_c9_SistemaCAS_v21(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initialize_params_c9_SistemaCAS_v21
  (SFc9_SistemaCAS_v21InstanceStruct *chartInstance);
static void enable_c9_SistemaCAS_v21(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void disable_c9_SistemaCAS_v21(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void c9_update_debugger_state_c9_SistemaCAS_v21
  (SFc9_SistemaCAS_v21InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_SistemaCAS_v21
  (SFc9_SistemaCAS_v21InstanceStruct *chartInstance);
static void set_sim_state_c9_SistemaCAS_v21(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c9_st);
static void finalize_c9_SistemaCAS_v21(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void sf_gateway_c9_SistemaCAS_v21(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void initSimStructsc9_SistemaCAS_v21(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c9_perda_transmissao5, const char_T
  *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_SistemaCAS_v21InstanceStruct
...
static real_T c9_log10(SFc9_SistemaCAS_v21InstanceStruct *chartInstance, real_T
  c9_x);
static void c9_eml_error(SFc9_SistemaCAS_v21InstanceStruct *chartInstance);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_d_emlrt_marshallIn(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_SistemaCAS_v21, const char_T *
  c9_identifier);
static uint8_T c9_e_emlrt_marshallIn(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_log10(SFc9_SistemaCAS_v21InstanceStruct *chartInstance, real_T *
  c9_x);
static void init_dsm_address_info(SFc9_SistemaCAS_v21InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_SistemaCAS_v21 = 0U;
}
  ...
  (SFc9_SistemaCAS_v21InstanceStruct *chartInstance)
{
  ...
  c9_f_hoistedGlobal = chartInstance->c9_is_active_c9_SistemaCAS_v21;
  ...
  *chartInstance, const mxArray *c9_st)
{
  ...
  *c9_perda_transmissao5 = c9_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c9_is_active_c9_SistemaCAS_v21 = c9_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 5)),
     "is_active_c9_SistemaCAS_v21");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_SistemaCAS_v21(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c9_b_k, 0U);
  for (c9_i0 = 0; c9_i0 < 5; c9_i0++) {
    _SFD_DATA_RANGE_CHECK((*c9_b_alfa)[c9_i0], 1U);
  }
  ...
  for (c9_i1 = 0; c9_i1 < 5; c9_i1++) {
    c9_alfa[c9_i1] = (*c9_b_alfa)[c9_i1];
  }

  for (c9_i2 = 0; c9_i2 < 5; c9_i2++) {
    c9_caminhos[c9_i2] = (*c9_b_caminhos)[c9_i2];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 20U, 20U, c9_debug_family_names,
    c9_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_espgeo1, 0U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_espgeo2, 1U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_espgeo3, 2U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_espgeo4, 3U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_espgeo5, 4U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_abs1, 5U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_abs2, 6U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_abs3, 7U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_abs4, 8U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_abs5, 9U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_nargout, 11U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c9_k, 12U, c9_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c9_alfa, 13U, c9_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c9_caminhos, 14U, c9_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao1, 15U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao2, 16U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao3, 17U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao4, 18U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_perda_transmissao5, 19U,
    c9_sf_marshallOut, c9_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 13);
  c9_d0 = c9_caminhos[0];
  c9_b_log10(chartInstance, &c9_d0);
  c9_espgeo1 = c9_k * 10.0 * c9_d0;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 14);
  c9_d1 = c9_caminhos[1];
  c9_b_log10(chartInstance, &c9_d1);
  c9_espgeo2 = c9_k * 10.0 * c9_d1;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 15);
  c9_d2 = c9_caminhos[2];
  c9_b_log10(chartInstance, &c9_d2);
  c9_espgeo3 = c9_k * 10.0 * c9_d2;
  sf_mex_printf("%s =\\n", "espgeo3");
  c9_u = c9_espgeo3;
  c9_y = NULL;
  ...
  c9_espgeo5 = c9_k * 10.0 * c9_d4;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 19);
  c9_abs1 = c9_alfa[0] * c9_caminhos[0] * 0.001;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 20);
  c9_abs2 = c9_alfa[0] * c9_caminhos[1] * 0.001;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 21);
  c9_abs3 = c9_alfa[0] * c9_caminhos[2] * 0.001;
  sf_mex_printf("%s =\\n", "abs3");
  c9_c_u = c9_abs3;
  c9_c_y = NULL;
  ...
  c9_abs4 = c9_alfa[0] * c9_caminhos[3] * 0.001;
  sf_mex_printf("%s =\\n", "abs4");
  c9_d_u = c9_abs4;
  c9_d_y = NULL;
  ...
  c9_abs5 = c9_alfa[0] * c9_caminhos[4] * 0.001;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 26);
  c9_perda_transmissao1 = c9_espgeo1 + c9_abs1;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 27);
  c9_perda_transmissao2 = c9_espgeo2 + c9_abs2;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 28);
  c9_perda_transmissao3 = c9_espgeo3 + c9_abs3;
  sf_mex_printf("%s =\\n", "perda_transmissao3");
  c9_e_u = c9_perda_transmissao3;
  c9_e_y = NULL;
  sf_mex_assign(&c9_e_y, sf_mex_create("y", &c9_e_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c9_e_y);
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 29);
  c9_perda_transmissao4 = c9_espgeo4 + c9_abs4;
  sf_mex_printf("%s =\\n", "perda_transmissao4");
  c9_f_u = c9_perda_transmissao4;
  c9_f_y = NULL;
  sf_mex_assign(&c9_f_y, sf_mex_create("y", &c9_f_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c9_f_y);
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 30);
  c9_perda_transmissao5 = c9_espgeo5 + c9_abs5;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, -30);
  ...
  *c9_b_perda_transmissao5 = c9_perda_transmissao5;
  ...
  _SFD_DATA_RANGE_CHECK(*c9_b_perda_transmissao1, 2U);
  for (c9_i3 = 0; c9_i3 < 5; c9_i3++) {
    _SFD_DATA_RANGE_CHECK((*c9_b_caminhos)[c9_i3], 3U);
  }

  _SFD_DATA_RANGE_CHECK(*c9_b_perda_transmissao2, 4U);
  _SFD_DATA_RANGE_CHECK(*c9_b_perda_transmissao3, 5U);
  _SFD_DATA_RANGE_CHECK(*c9_b_perda_transmissao4, 6U);
  _SFD_DATA_RANGE_CHECK(*c9_b_perda_transmissao5, 7U);
}
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_SistemaCAS_v21InstanceStruct *chartInstance;
  chartInstance = (SFc9_SistemaCAS_v21InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_SistemaCAS_v21_get_eml_resolved_functions_info(void)
{
  const mxArray *c9_nameCaptureInfo = NULL;
  c9_nameCaptureInfo = NULL;
  sf_mex_assign(&c9_nameCaptureInfo, sf_mex_createstruct("structure", 2, 13, 1),
                false);
  ...
  c9_identifier)
{
  ...
  c9_y = c9_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_SistemaCAS_v21), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_SistemaCAS_v21);
  return c9_y;
}
...
void sf_c9_SistemaCAS_v21_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1787278058U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1192197327U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(605766295U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(811022220U);
}

mxArray *sf_c9_SistemaCAS_v21_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("R6B5JUObOrogWuUWHsDHQE");
...
mxArray *sf_c9_SistemaCAS_v21_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_SistemaCAS_v21_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c9_SistemaCAS_v21(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"perda_transmissao1\",},{M[1],M[9],T\"perda_transmissao2\",},{M[1],M[10],T\"perda_transmissao3\",},{M[1],M[11],T\"perda_transmissao4\",},{M[1],M[12],T\"perda_transmissao5\",},{M[8],M[0],T\"is_active_c9_SistemaCAS_v21\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_SistemaCAS_v21_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_SistemaCAS_v21InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1120);
...
{
  return "fJrYrPc07iJ9Xxb5L3uJJH";
}

static void sf_opaque_initialize_c9_SistemaCAS_v21(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
  initialize_c9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_SistemaCAS_v21(void *chartInstanceVar)
{
  enable_c9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_SistemaCAS_v21(void *chartInstanceVar)
{
  disable_c9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_SistemaCAS_v21(void *chartInstanceVar)
{
  sf_gateway_c9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_SistemaCAS_v21(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_SistemaCAS_v21
    ((SFc9_SistemaCAS_v21InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v21();/* state var info */
...
extern void sf_internal_set_sim_state_c9_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c9_SistemaCAS_v21();/* state var info */
  ...
  set_sim_state_c9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_SistemaCAS_v21(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_SistemaCAS_v21(S);
}

static void sf_opaque_set_sim_state_c9_SistemaCAS_v21(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_SistemaCAS_v21(S, st);
}

static void sf_opaque_terminate_c9_SistemaCAS_v21(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_SistemaCAS_v21InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_SistemaCAS_v21((SFc9_SistemaCAS_v21InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_SistemaCAS_v21(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1407909644U));
  ssSetChecksum1(S,(1581232916U));
  ssSetChecksum2(S,(3483547903U));
  ssSetChecksum3(S,(3084544993U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c9_SistemaCAS_v21(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_SistemaCAS_v21(SimStruct *S)
{
  SFc9_SistemaCAS_v21InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_SistemaCAS_v21InstanceStruct *)utMalloc(sizeof
    (SFc9_SistemaCAS_v21InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_SistemaCAS_v21InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_SistemaCAS_v21;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_SistemaCAS_v21;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_SistemaCAS_v21;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_SistemaCAS_v21;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_SistemaCAS_v21;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_SistemaCAS_v21;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_SistemaCAS_v21;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_SistemaCAS_v21;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_SistemaCAS_v21;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_SistemaCAS_v21;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_SistemaCAS_v21;
...
void c9_SistemaCAS_v21_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_SistemaCAS_v21(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_SistemaCAS_v21(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_SistemaCAS_v21_method_dispatcher.\n"
