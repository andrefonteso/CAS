...
%-----------------------------------------------------------------------
% Esse código analisa a desnsidade espectral de potencia - DSP do ruído em
% decibéis (dB) presente no canal de comunicação do arquivo 
% sistema_cas_oficial.slx
%%
close all
...
ylabel('Amplitude do Sinal sem Ruído (dB)')
...
xlabel('Frequência (kHz)')
ylabel('Amplitude do Sinal com Ruído (dB)')
